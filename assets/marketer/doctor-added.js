$(document).ready(function () {
    ...
    $('.dropdown-options div').on('click', function () {
        ...
        $('#city').val(selectedText); // Set input value (visible text)
        $('#city').attr('data-selected-value', selectedValue); // Store data-value in a custom attribute
    });
    ...
    $('#submit-doctor-datas').click(function (event) {
        ...
        var cityValue = $('#city').attr('data-selected-value'); // Retrieve stored data-value
