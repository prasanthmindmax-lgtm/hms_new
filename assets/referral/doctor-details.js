...
function renderTable(data, pageSize, pageNum) {
    ...
    $.each(pageData, function(index, user) {
        ...
        body += '<tr onclick="rowClick(event)">' +
                ...
                '<td class="tdview" id="cityviews" data-citys="' + user.city + '" data-hospital="' + user.hopsital_name + '">' + user.hopsital_name + '<br>' + limitAddress + '......<br></td>' +
               ...
               '<td class="tdview tooltip-container" id="employeename" data-emp="' + user.employee_name + '"><img src="../assets/images/user/avatar-1.jpg" style="width: 20px;" alt="Icon"class="img-user rounded-circle" title="' + user.userfullname + '-'+ user.empolyee_name +'"></td>'+
...
function renderPagination(data, pageSize) {
    ...
    $('.page-btn').click(function() {
        ...
        $('.page-btn').removeClass('active').css('background-color', '#ffffff'); // Reset all buttons
        $(this).addClass('active').css('background-color', ' #080fd399'); // Highlight active button
