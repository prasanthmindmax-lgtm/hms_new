  ...
  if (layout !== null && layout !== '') {
    ...
    if (layout === 'horizontal') {
      ...
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
        document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', 'https://draravinds.com/tasks/assets/images/dralogos.png');
      }
    } else if (layout === 'compact') {
      script.src = 'https://draravinds.com/tasks/assets/js/layout-compact.js'; // Load script for compact layout
      document.body.appendChild(script);
    } else if (layout === 'tab') {
      script.src = 'https://draravinds.com/tasks/assets/js/layout-tab.js'; // Load script for tab layout
      document.body.appendChild(script);
    }
  }
...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', 'https://draravinds.com/tasks/assets/images/dralogos.png');
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', 'https://draravinds.com/tasks/assets/images/dralogos.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', 'https://draravinds.com/tasks/assets/images/dralogos.png');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', 'https://draravinds.com/tasks/assets/images/dralogos.png');
    }
