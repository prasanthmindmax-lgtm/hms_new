...
setTimeout(function () {
  (function () {
    ...
    var options_bar_chart_2 = {
      ...
      colors: ['#D072AE', '#2ca87f', '#e58a00', '#13c2c2'],
      responsive: [
        {
          breakpoint: 480,
          options: {
    ...
    var options_bar_chart_4 = {
      ...
      colors: ['#D072AE', '#13c2c2', '#2ca87f', '#e58a00', '#DC2626'],
      stroke: {
        width: 1,
        colors: ['#fff']
      },
    ...
    var options_bubble_chart_1 = {
      ...
      colors: ['#D072AE', '#2ca87f', '#e58a00', '#DC2626'],
      fill: {
        opacity: 0.8
      },
      xaxis: {
    ...
    var options_scatter_chart_1 = {
      ...
      colors: ['#D072AE', '#2ca87f', '#DC2626', '#e58a00', '#13c2c2'],
      series: [
        {
          name: 'SAMPLE A',
          data: [
    ...
    var options_pie_chart_1 = {
      ...
      colors: ['#D072AE', '#2ca87f', '#13c2c2', '#e58a00', '#DC2626'],
      legend: {
        show: true,
        position: 'bottom'
      },
