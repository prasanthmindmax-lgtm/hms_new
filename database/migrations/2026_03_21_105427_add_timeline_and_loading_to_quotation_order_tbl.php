...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('quotation_order_tbl', function (Blueprint $table) {
            if (!Schema::hasColumn('quotation_order_tbl', 'timeline_date')) {
                $table->string('timeline_date')->nullable()->after('subject');
            }
            if (!Schema::hasColumn('quotation_order_tbl', 'loading_unloading_name')) {
                $table->string('loading_unloading_name')->nullable()->after('export_amount');
            }
            if (!Schema::hasColumn('quotation_order_tbl', 'loading_unloading_amount')) {
