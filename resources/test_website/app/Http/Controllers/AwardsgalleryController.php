...
class AwardsgalleryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'awardsgallery';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Awardsgallery();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'awardsgallery',
	...
	public static function display(  )
	{
		...
		$model  = new Awardsgallery();
		$info = $model::makeInfo('awardsgallery');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('awardsgallery.public.view',$data);			
			}			
		} 
		else {
			...
			return view('awardsgallery.public.index',$data);	
		}
