...
class CareerformController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('careerform');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('careerform.public.view',$data);			
			}			
		} 
		else {
			...
			return view('careerform.public.index',$data);	
		}
