...
class TrainingformController extends Controller {
	...
	public $module = 'trainingform';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Trainingform();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'trainingform',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('trainingform');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('trainingform.public.view',$data);			
			}			
		} 
		else {
			...
			return view('trainingform.public.index',$data);	
		}
