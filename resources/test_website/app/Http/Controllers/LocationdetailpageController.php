...
class LocationdetailpageController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'locationdetailpage';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Locationdetailpage();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'locationdetailpage',
			...
			default:
				...
				if ($validator->passes()) 
				{
					...
					if(!is_null($request->file('banner_image')))
					{
						...
						$destinationPath = './uploads/locationdetail/';
	...
	public static function display(  )
	{
		...
		$model  = new Locationdetailpage();
		$info = $model::makeInfo('locationdetailpage');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('locationdetailpage.public.view',$data);			
			}			
		} 
		else {
			...
			return view('locationdetailpage.public.index',$data);	
		}
