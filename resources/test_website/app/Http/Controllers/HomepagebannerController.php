...
class HomepagebannerController extends Controller {
	...
	public $module = 'homepagebanner';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Homepagebanner();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'homepagebanner',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('homepagebanner');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('homepagebanner.public.view',$data);			
			}			
		} 
		else {
			...
			return view('homepagebanner.public.index',$data);	
		}
