...
class TreatmentsController extends Controller {
		...
		switch ($task)
		{
			default:
				...
				if ($validator->passes()) 
				{
					...
					// $our_service_arr = array();
					// $our_service_arr=$request->treat_ourservice;
					
					// foreach($our_service_arr as $key => $val){
					// 	if(empty($val)){
     //   						 unset($our_service_arr[$key]);
					// 	}
					// }
				...
				$data['meta_desc'] = $request->meta_desc;
					...
					$data['treat_ourservice'] = $request->treat_ourservice;
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('treatments');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('treatments.public.view',$data);			
			}			
		} 
		else {
			...
			return view('treatments.public.index',$data);	
		}
