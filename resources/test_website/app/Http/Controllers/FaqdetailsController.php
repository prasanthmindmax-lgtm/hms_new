...
class FaqdetailsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'faqdetails';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Faqdetails();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'faqdetails',
	...
	public static function display(  )
	{
		...
		$model  = new Faqdetails();
		$info = $model::makeInfo('faqdetails');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('faqdetails.public.view',$data);			
			}			
		} 
		else {
			...
			return view('faqdetails.public.index',$data);	
		}
