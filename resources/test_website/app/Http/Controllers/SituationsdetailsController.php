...
class SituationsdetailsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'situationsdetails';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Situationsdetails();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'situationsdetails',
	...
	public static function display(  )
	{
		...
		$model  = new Situationsdetails();
		$info = $model::makeInfo('situationsdetails');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('situationsdetails.public.view',$data);			
			}			
		} 
		else {
			...
			return view('situationsdetails.public.index',$data);	
		}
