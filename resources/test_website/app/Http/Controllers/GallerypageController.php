...
class GallerypageController extends Controller {
	...
	public $module = 'gallerypage';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Gallerypage();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'gallerypage',
	...
	public function index( Request $request )
	{
		...
		$this->data['pagemeta'] = Pagemeta::where('pagename','gallerypage')->first();
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('gallerypage');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('gallerypage.public.view',$data);			
			}			
		} 
		else {
			...
			return view('gallerypage.public.index',$data);	
		}
