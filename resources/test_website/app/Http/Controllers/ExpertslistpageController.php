...
class ExpertslistpageController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'expertslistpage';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Expertslistpage();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'expertslistpage',
	...
	function create( Request $request , $id =0 ) 
	{
		...
		$expertlist_data = Expertslistpage::get();
			if(count($expertlist_data) == 0) {
				$this->data['row'] = $this->model->getColumnTable( $this->info['table']); 
				$this->data['id'] = '';
				return view($this->module.'.form',$this->data);
			}
			else{
				$id = $expertlist_data[0]['id'];
	...
	public static function display(  )
	{
		...
		$model  = new Expertslistpage();
		$info = $model::makeInfo('expertslistpage');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('expertslistpage.public.view',$data);			
			}			
		} 
		else {
			...
			return view('expertslistpage.public.index',$data);	
		}
