...
class SuccessstoriesController extends Controller {
	...
	public $module = 'successstories';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Successstories();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'successstories',
			...
			default:
				...
				if ($validator->passes()) 
				{
					...
					if(!is_null($request->file('image')))
					{
						...
						$destinationPath = './uploads/successstories/';
					...
					$data['embedded_url'] = $request->embedded_url;
					$data['more_video_url'] = $request->more_video_url;
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('successstories');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('successstories.public.view',$data);			
			}			
		} 
		else {
			...
			return view('successstories.public.index',$data);	
		}
