...
class TreatmentpageController extends Controller {
	...
	public $module = 'treatmentpage';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Treatmentpage();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'treatmentpage',
	...
	public static function display(  )
	{
		...
		$model  = new Treatmentpage();
		$info = $model::makeInfo('treatmentpage');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('treatmentpage.public.view',$data);			
			}			
		} 
		else {
			...
			return view('treatmentpage.public.index',$data);	
		}
