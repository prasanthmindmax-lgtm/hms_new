...
class TreatmentcategoryController extends Controller {
	...
	public $module = 'treatmentcategory';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Treatmentcategory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'treatmentcategory',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('treatmentcategory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('treatmentcategory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('treatmentcategory.public.index',$data);	
		}
