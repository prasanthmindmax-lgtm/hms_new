...
<div class="panel panel-custom">
    <div class="panel-heading">
        ...
        <h4 class="modal-title"
            id="myModalLabel"><?= lang('new') . ' ' . 'Job Post' ?></h4>
    </div>
        ...
        <form id="form" role="form" enctype="multipart/form-data" data-parsley-validate="" novalidate=""
            ...
            <div class="form-group" id="border-none">
                <label for="field-1" class="col-sm-3 control-label"><?= lang('vacancy_no') ?><span
                        class="required"> *</span></label>
                <div class="col-sm-5">
                    <input type="number" onkeydown="return event.keyCode !== 69" id="vacancy_no" pattern="[0-9]" name="vacancy_no" value="<?php
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="input-group ">
                        ...
                        ?>" class="form-control datepicker" id="from" name="posted_date">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="input-group ">
                        ...
                        ?>" id="to" class="form-control datepicker" name="last_date" onchange="validateTo()">
...
function validateTo() {
  ...
  if (from > to) {
    alert("The 'Posted Date' date must be before or equal to the 'Last Date' date.");
