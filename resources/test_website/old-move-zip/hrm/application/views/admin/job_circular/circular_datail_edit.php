...
<link href="https://cdn.rawgit.com/harvesthq/chosen/gh-pages/chosen.min.css" rel="stylesheet"/>
    ...
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
            <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="<?= base_url('admin/job/user_list') ?>"><? echo $title; ?></a></li>
                ...
                <form enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/job/update_job/<?= $job->id ?>"method="post" class="form-horizontal"  data-parsley-validate="">
                   ...
                   <div class="chart tab-pane active" id="personal_detail">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->name;?>" placeholder="Name" name="name" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="email" id="check_email_addrees" placeholder="Email ID" name="email" value="<?php echo $job->email;?>" class="input-sm form-control" required readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number" class="input-sm form-control" value="<?php echo $job->mobile;?>"  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" name="mobile" placeholder="Mobile" required readonly>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="number"  class="input-sm form-control" value="<?php echo $job->total_no_experience;?>" placeholder="Total Number Of Experience" name="total_no_experience" required pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==2) return false;" readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="date" class="input-sm form-control" value="<?php echo $job->dob;?>" placeholder="Date of birth" name="dob" required readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Age </strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <input type="number"  class="input-sm form-control" value="<?php echo $job->age;?>" placeholder="Age" name="age" required pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==2) return false;" readonly />
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Religion </strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->religion;?>" placeholder="Religion" required name="religion" readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Mother Tongue </strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->mother_tongue;?>" placeholder="Mother Tongue" name="mother_tongue" required readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Caste </strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->caste;?>" placeholder="Caste" name="caste" required readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Blood Group </strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->blood_group;?>" placeholder="Blood Group " name="blood_group" required readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Marital Status </strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <select  class="input-sm form-control" name="marital_status" readonly >
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
						<select data-placeholder="Select Choice Of Work" name="choice_of_work[]" multiple class="input-sm form-control chosen-select" required readonly>
						 <option value="">Select</option>
...
$(".chosen-select").chosen({
  no_results_text: "Oops, nothing found!"
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="number" class="input-sm form-control" value="<?php echo $job->secondary_contact_number;?>" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==10) return false;" placeholder="Secondary Contact Number" name="secondary_contact_number" required readonly >
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Secondary Contact Relationship</strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <select  class="input-sm form-control" name="secondary_contact_relationship" required readonly>
						   <option value="">Select</option>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->permanent_address;?>" placeholder="Permanent Address" name="permanent_address" required readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Present Address</strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->present_address;?>" placeholder="Present Address" name="present_address" required readonly>
                        </div>
                    </div>
					 </div>
					   <!-- ************** End Personal detail *************-->
...
?>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $value; ?>" placeholder=" Qualification" name="qualification[]" readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="date" class="input-sm form-control" value="<?php echo $year[$key]; ?>" placeholder="Year" name="year[]" readonly>
                        </div>
						</div>
						<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Name of institution / University </strong><span class="text-danger"></span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $institution[$key]; ?>" placeholder="Name of institution / University " name="institution[]" readonly>
                        </div>
						</div>
						<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Class / Percentage obtained </strong><span class="text-danger"></span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $percentage[$key]; ?>" placeholder="Class / Percentage obtained" name="percentage[]" readonly>
                        </div>
						</div>
		<?php } ?>				
</div>		
...
?>
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $value; ?>" placeholder="Organization" name="organization[]" readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $designation[$key]; ?>" placeholder="Designation" name="designation[]" readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="date" class="input-sm form-control" value="<?php echo $previous_experiance_year[$key]; ?>" placeholder="" name="previous_experiance_year[]" readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $salary[$key]; ?>" placeholder="Salary Drawn per Month" name="salary[]" readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $reason_leaving[$key]; ?>" placeholder="Reason for Leaving" name="reason_leaving[]" readonly>
                        </div>
						</div>
...
$(document).ready(function(){
    ...
    $(wrapperExp).on('click', '.experience_remove_button', function(e){
        ...
        x--; //Decrement field counter
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->computer_literacy;?>" placeholder="Computer Literacy " name="computer_literacy" required readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->other_skill;?>" placeholder="Other Skills  " name="other_skill" required readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->stay;?>" placeholder="Stay" name="stay" required readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->max_year_guarented_stay;?>" placeholder="Minimum Years Guarenteed to Stay" name="max_year_guarented_stay" required readonly>
                        </div>
						</div>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="date" class="input-sm form-control" value="<?php echo $job->date_of_joining;?>" placeholder="Probable of Date of Joining" name="date_of_joining" required readonly>
                        </div>
						</div>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                          <select  class="input-sm form-control" name="working_hours" required readonly>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->salary_expected;?>" placeholder="Salary Expected" name="salary_expected" required readonly>
                        </div>
						</div>
				...
				<!-- ************** End Education *************-->				
					...
					<!-- ************** Start Other Details *************-->
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->pesonal_identification_mark;?>" placeholder="Personal Identification Marks" name="pesonal_identification_mark" required readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="number" class="input-sm form-control"  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==3) return false;"  value="<?php echo $job->height;?>" placeholder="Height in cm" name="height" required readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="number" class="input-sm form-control" value="<?php echo $job->weight;?>"  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==3) return false;"  placeholder="Weight in kg" name="weight" required readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->treatement;?>" placeholder="if Yes Details & Nature of Treatment" name="treatement" required readonly>
                        </div>
						</div>
						<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Photo ID Proof</strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <select  class="input-sm form-control" name="photo_proof" required readonly>
						   <option value="">Select</option>
					...
					<div class="add_language">	
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
							   <input type="text" class="input-sm form-control" value="<?php echo $language['language']; ?>" placeholder="Language" name="language[]" required readonly>
							</div>
						</div>
						<div class="form-group">
...
<?php foreach($reference_name as $key => $value) { ?>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Name</strong><span class="text-danger"></span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $value ?>" placeholder="Name" name="reference_name[]" readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="number" class="input-sm form-control" value="<?php echo $reference_contact_no[$key] ?>"  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==3) return false;" placeholder="Contact Number" name="reference_contact_no[]" readonly>
                        </div>
						</div>
                        ...
                        <label class="col-sm-3 control-label"><strong>Designation</strong><span class="text-danger"></span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $reference_designation[$key] ?>" placeholder="Designation" name="reference_designation[]" readonly>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $reference_institution[$key] ?>" placeholder="Institution" name="reference_institution[]" readonly>
                        </div>
						</div>
