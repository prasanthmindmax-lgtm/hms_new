...
<div class="panel panel-custom">
    ...
    <div class="panel-body form-horizontal">
        ...
        <div class="col-md-4">
            ...
            <?php /*<a href="<?= base_url() ?>frontend/apply_jobs/<?= $circular_details->job_circular_id ?>"
               class="btn btn-primary btn-block" data-toggle="modal"
               data-target="#myModal_lg"><?= lang('apply_now') ?></a>*/ ?>
               <a href="<?= base_url() ?>frontend/job/<?= $circular_details->job_circular_id ?>" class="btn btn-primary btn-block"><?= lang('apply_now') ?></a>
        </div>
        <?php endif; ?>
    </div>
</div>
