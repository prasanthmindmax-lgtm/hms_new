...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content bg-white">
        <h3>Job Title:<?php echo ' '.$job_title[0]->job_title; ?></h3>
        <div class="tab-pane active" id="new">
            <form enctype="multipart/form-data" action="<?php echo base_url(); ?>frontend/apply_job_stored/" method="post" class="form-horizontal" data-parsley-validate="">
                ...
                <div class="panel-body">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content bg-white">
                            ...
                            <input type="hidden" name="job_circular_id" value="<?php echo $job_circular_id; ?>">
                            <div class="chart tab-pane active over_hi_cler" id="personal_detail">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select data-placeholder="Select Choice Of Work" name="choice_of_work[]" class="chosen-select" multiple required>
                                            <option value="">Select</option>
