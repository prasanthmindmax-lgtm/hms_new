    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content bg-white">
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="new">
                <form enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/job/update_job/<?= $job->id ?>"method="post" class="form-horizontal">
                   ...
                   <div class="chart tab-pane active" id="personal_detail">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="input-sm form-control" value="<?php echo $job->mobile;?>" name="mobile" placeholder="Mobile" required>
                        </div>
                    </div>
                                ...
                                <div>
                                    <span class="btn btn-default btn-file">
                                        <span class="fileinput-new">
                                            <input type="file" name="resume" value="upload"  />
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                         In master   <input type="checkbox"  value="inmaster"<?php if( $job->choice_of_work === 'inmaster') { echo "checked"; } ?> name="choice_of_work" >
						 Hospotal Location  <input type="checkbox" value="hospotal_location"<?php if( $job->choice_of_work === 'hospotal_location') { echo "checked"; } ?> name="choice_of_work" >
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-sm-3 control-label"><strong>Secondary Contact Number</strong><span class="text-danger">*</span></label>
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->secondary_contact_number;?>" placeholder="Secondary Contact Number" name="secondary_contact_number" required >
                        </div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->secondary_contact_mobile;?>" placeholder="Secondary Contact Mobile" name="secondary_contact_mobile" required>
                        </div>
                    </div>
					<div class="form-group">
        ...
        x--; //Decrement field counter
				...
				<!-- ************** End Education *************-->				
					...
					<!-- ************** Start Other Details *************-->
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->height;?>" placeholder="Height in cm" name="height" required>
                        </div>
						</div>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $job->weight;?>" placeholder="Weight in kg" name="weight" required>
                        </div>
						</div>
...
$languages_know=explode(',',$job->languages_know);
?>
...
<?php foreach($language as $key => $value) { ?>
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $value; ?>" placeholder="Language" name="language[]" required >
                        </div>
						</div>
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
						   ...
						   <option value="">Select</option>
						   <option value="Read"<?php if($languages_know[$key]=='Read'){ echo "selected"; }?>>Read</option>
						   <option value="Write"<?php if($languages_know[$key]=='Write'){ echo "selected"; }?>>Write</option>
						   <option value="Speak"<?php if($languages_know[$key]=='Speak'){ echo "selected"; }?>>Speak</option>
						   </select>
                        </div>
                    </div>	
...
$(document).ready(function(){
    ...
    var fieldHTMLLan = '<div><div class="form-group"><label class="col-sm-3 control-label"><strong>Language</strong><span class="text-danger">*</span></label><div class="col-sm-5"><input type="text" class="input-sm form-control" value="" placeholder="Language" name="language[]" required ></div></div><div class="form-group"><label class="col-sm-3 control-label"><strong>Languages Known</strong><span class="text-danger">*</span></label><div class="col-sm-5"><select  class="input-sm form-control" name="languages_know[]" required multiple><option value="">Select</option><option value="Read">Read</option><option value="Write">Write</option><option value="Speak">Speak</option></select></div></div><a href="javascript:void(0);" class="language_remove_button btn btn-danger">-</a></div>'; //New input field html 
    var x = 1; //Initial field counter is 1
...
<?php foreach($reference_name as $key => $value) { ?>
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                           <input type="text" class="input-sm form-control" value="<?php echo $reference_contact_no[$key] ?>" placeholder="Contact Number" name="reference_contact_no[]" >
                        </div>
						</div>
