...
<body <?= $body_style ?>>
    ...
    <div class="<?= $lcol ?>">
            ...
            <ul class="nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animated zoomIn">
                        ...
                        ?>
                            <li>
                                <a href="<?= base_url() ?>admin/common/set_language/<?= $lang->name ?>" title="<?= ucwords(str_replace("_", " ", $lang->name)) ?>">
        ...
        <div class="wrapper" style="margin: 20% 0 0 auto">
            <div class="block-center mt-xl wd-xl">
                <div class="text-center" style="margin-bottom: 20px; background: #fff;
    padding: 10px;
    border-radius: 5px;">
                    <img style="width: 100%;" src="<?= base_url() . config_item('company_logo') ?>" class="m-r-sm">
                </div>
                <?= message_box('success'); ?>
                <?= message_box('error'); ?>
                ...
                <div class="p-lg text-center">
                    <span>&copy;</span>
                    <span><a href="<?= config_item('copyright_url') ?>"> <?= config_item('copyright_name') ?></a>&nbsp;<span><?= date('Y') ?></span></span>
                    <?php /*<span>-</span>
    ...
    <?php if (!empty(config_item('allow_apply_job_from_login'))) { ?>
     <!--   <a class="pull-right btn btn-info btn-lg mt0 apply_jobs" href="<?= base_url() ?>career">Appy For New Job</a> -->
    <?php } ?>
    <?php
    ...
    <div class="<?= $col ?> hidden-xs" <?= $leftstyle ?>>
        <?php if (!empty($login_background[0]) && $login_background[0] == 'video') { ?>
            <video class="bgvid inner" autoplay="autoplay" muted="muted" preload="auto" loop>
                <source src="<?php echo base_url() . config_item('login_background'); ?>" type="video/webm">
            </video>
        <?php } ?>
    </div>
