...
class Stock extends Admin_Controller
{
    ...
    public function create_stockcategory($id = null, $sub_id = null)
    {
        $edited = can_action('76', 'edited');
        $data['title'] = lang('all') . ' ' . lang('stock_category');
        $data['active'] = 2;
        ...
        $data['subview'] = $this->load->view('admin/stock/create_stockcategory', $data, TRUE);
        $this->load->view('admin/_layout_main', $data);
    }
    ...
    public function create_stocklist($id = null, $h = null)
    {
        ...
        $data['subview'] = $this->load->view('admin/stock/create_stocklist', $data, TRUE);
        $this->load->view('admin/_layout_main', $data);
    }
    ...
    public function create_assignstock($id = NULL)
    {
        $data['title'] = lang('assign_stock');
        ...
        $data['subview'] = $this->load->view('admin/stock/create_assignstock', $data, TRUE);
        $this->load->view('admin/_layout_main', $data);
    }
    ...
    public function assign_stockList($id = null, $type = null)
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($fetch_data as $_key => $v_assign_stock) {
                ...
                $sub_array[] = $v_assign_stock->stock_category . ' ' . $v_assign_stock->stock_sub_category;
