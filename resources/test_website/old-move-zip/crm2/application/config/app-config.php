...
*
*/
define('APP_BASE_URL', 'https://draravindsivf.com/crm2/');
...
*/
define('APP_ENC_KEY', 'cef595d1a6f8acf75e161f7f42fdfa88');
 ...
 */
define('APP_DB_USERNAME', 'draravin_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'BIVh#057WazB');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'draravin_crm');
