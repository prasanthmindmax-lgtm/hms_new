...
<div class="panel_s mtop25">
    ...
    ?>
                ...
                <?php echo render_select('preferred_location', get_all_locations(), [ 'id', [ 'name']], 'lead_preferred_location', $lead->preferred_location, ['data-none-selected-text' => _l('dropdown_non_selected_tex')]);?>
