            ...
            <div class="col-md-6 col-xs-12 lead-information-col">
                ...
                <dl>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo "Wife Name"; ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 lead-name">
                        <?php echo(isset($lead) && $lead->name != '' ? $lead->name : '-') ?></dd>
						
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo "Husband Name"; ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 lead-name">
                        <?php echo(isset($lead) && $lead->husbandname != '' ? $lead->husbandname : '-') ?></dd>
						
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo "Wife Number"; ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->phonenumber != '' ? '<a href="tel:' . $lead->phonenumber . '">' . $lead->phonenumber . '</a>' : '-').' WhatsApp :'.$lead->wife_whatsapp_no ?>
                    </dd>	
					 
					 <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo "Husband Number"; ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 lead-name">
                        <?php echo(isset($lead) && $lead->husband_number != '' ? $lead->husband_number : '-').' WhatsApp :'.$lead->husband_whatsapp_no ?></dd>
						
`					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo "Husband Age"; ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 lead-name">
                        <?php echo(isset($lead) && $lead->husbandage != '' ? $lead->husbandage : '-') ?></dd>
						
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo "Wife Age"; ?></dt>
                      <dd class="tw-text-neutral-900 tw-mt-1 lead-name">
                        <?php echo(isset($lead) && $lead->wifeage != '' ? $lead->wifeage : '-') ?></dd>	
						
						
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500" style="display:none"><?php echo _l('lead_title'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1" style="display:none">
                        <?php echo(isset($lead) && $lead->title != '' ? $lead->title : '-') ?>
                    </dd>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500" style="display:none">
                        <?php echo _l('lead_add_edit_email'); ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1" style="display:none">
                        <?php echo(isset($lead) && $lead->email != '' ? '<a href="mailto:' . $lead->email . '">' . $lead->email . '</a>' : '-') ?>
                    </dd>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500" style="display:none"><?php echo _l('lead_website'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1"  style="display:none">
                        <?php echo(isset($lead) && $lead->website != '' ? '<a href="' . maybe_add_http($lead->website) . '" target="_blank">' . $lead->website . '</a>' : '-') ?>
                    </dd>
                    
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500" style="display:none"><?php echo _l('lead_value'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1" style="display:none">
                        <?php echo(isset($lead) && $lead->lead_value != 0 ? app_format_money($lead->lead_value, $base_currency->id) : '-') ?>
                    </dd>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500" style="display:none"><?php echo _l('lead_company'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1" style="display:none">
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">Wife MRD No</dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->MDR != '' ? $lead->MDR : '-') ?></dd>
						
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">Husband MRD No</dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->husband_mdr != '' ? $lead->husband_mdr : '-') ?></dd>
						
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">Marriage at</dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->Marriage_at != '' ? date('d/m/Y', strtotime($lead->Marriage_at)) : '-') ?></dd>	
				<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">Married Years</dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->marriage_at_dates != '' ? $lead->marriage_at_dates : '-') ?></dd>	
						
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">Profile Group</dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->profile_group != '' ? $lead->profile_group : '-') ?></dd>		
						
                 <!--   <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">Whatsapp No</dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php //echo(isset($lead) && $lead->whatsapp != '' ? $lead->whatsapp : '-') ?></dd> -->
                </dl>
            </div>
            <div class="col-md-6 col-xs-12 lead-information-col">
                <div class="lead-info-heading">
                ...
                <dl>
					...
					<dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo "Attribute"; ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
                        <?php echo $att_name; ?></dd>
                  ...
                  ?>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500"><?php echo _l('lead_preferred_location'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
                        <?php echo(isset($lead) && $lead->preferred_location != 0 ? get_location($lead->preferred_location)->name : '-') ?>
                    </dd>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">Walk in Date 
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
                        <?php echo date('d/m/Y', strtotime($lead->walk_in_date)); ?>
                    </dd>
          ...
          ?>
			...
			<div class="col-md-4">
                <label for="attribute" class="control-label">Attribute</label>
				 <?php $value = (isset($lead) ? $lead->attribute_at : ''); ?>
				<select name="attribute_at" class="form-control" >
					<option value="">---Select---</option>
					<?php 
					
					foreach ($attributes as $at) {?>
					<option value="<?php echo $at['id']; ?>"<?php echo ($value == $at['id'] ? 'selected' : ''); ?>><?php echo $at['name']; ?></option>
					<?php } ?>
				</select>
            </div>
            <div class="clearfix"></div>
            ...
            <div class="col-md-6">
                ...
                <?php echo render_input('name', 'Wife name', $value, 'text', ['required' => 'required']); ?>
				 <?php 
				 $value = (isset($lead) ? $lead->husbandname : '');
				 echo render_input('husbandname', 'Husband name', $value, 'text'); ?>
				  <?php 
				  $value = (isset($lead) ? $lead->wifeage : '');
				  echo render_input('wifeage', 'Wife age', $value, 'number'); ?>
				  
				  <?php 
				  $value = (isset($lead) ? $lead->husband_number : '');
				  echo render_input('husband_number', 'Husband Number', $value, 'number'); ?>
				  <?php $value = (isset($lead) ? $lead->husband_whatsapp_no : '');
				  $isChecked = (!empty($value) && $value == 'yes' ? 'checked' : '');
				  ?>
				  <input type="hidden" name="husband_whatsapp_no" value="no">
				  <input type="checkbox" name="husband_whatsapp_no" id="husband_whatsapp_no" value="yes" <?php echo $isChecked; ?>> check this if  WhatsApp available 
				  <?php 
				  $value = (isset($lead) ? $lead->husbandage : '');
				  echo render_input('husbandage', 'Husband age', $value, 'number'); ?>
            ...
            //$value = (isset($lead) ? $lead->phonenumber : ''); ?>
                ...
                <?php $value = (isset($lead) ? $lead->MDR : ''); ?>
                <?php echo render_input('MDR', 'Wife MDR No', $value); ?>
				 <?php 
				 $value = (isset($lead) ? $lead->husband_mdr : '');
				 echo render_input('husband_mdr', 'Husband MDR No', $value); ?>
                <?php $value = (isset($lead) ? $lead->whatsapp : ''); ?>
                <?php //echo render_input('whatsapp', 'lead_whatsapp', $value); ?>
                <?php $value = (isset($lead) ? $lead->walk_in_date : ''); ?>
                <?php echo render_date_input('walk_in_date', 'Walk in Date', $value); ?>
            </div>
            <div class="col-md-6">
                <?php $value = (isset($lead) ? $lead->address : ''); ?>
                <?php echo render_textarea('address', 'lead_address', $value, ['rows' => 1, 'style' => 'height:36px;font-size:100%;']); ?>
				 <?php 
				 $value = (isset($lead) ? $lead->Marriage_at : '');
				 echo render_input('Marriage_at', 'Marriage at', $value, 'date', [ 'onchange'=>"calculateYears()"]); ?>
				 <p>Married Years:</p>
				  <?php $value = (isset($lead) ? $lead->marriage_at_dates : ''); ?>
				<input type="text" class="form-control" name="marriage_at_dates" id="result" value="<?php echo $value;?>" readonly>

				<script>
				function calculateYears() { 
				  const selectedDate = new Date(document.getElementById("Marriage_at").value);
				  const today = new Date();
				  const diffTime = Math.abs(today - selectedDate);
				  const diffYears = Math.floor(diffTime / (1000 * 60 * 60 * 24 * 365.25)); 
				  document.getElementById("result").value = diffYears;
				}
				</script>
				 ...
				 echo render_input('phonenumber', '<span style="color: red;">*</span> Wife Number', $value, 'number', ['required' => 'required']); ?>
				<?php $value = (isset($lead) ? $lead->wife_whatsapp_no : '');
				$isChecked = (!empty($value) && $value == 'yes' ? 'checked' : '');
				?>
				<input type="hidden" name="wife_whatsapp_no" value="no">
				  <input type="checkbox" name="wife_whatsapp_no" id="wife_whatsapp_no" value="yes" <?php echo $isChecked; ?>> check this if wife WhatsApp available
               ...
               ?>
                ...
                <?php echo render_select('preferred_location', get_all_locations(), [ 'id', [ 'name']], '<span style="color: red;">*</span>Preferred Location', $lead->preferred_location, ['data-none-selected-text' => _l('dropdown_non_selected_tex'),'required' => 'required']);?>
                
                <?php $value = (isset($lead) ? $lead->attribute : ''); ?>
                <?php //echo render_input('attribute', 'Attribute', $value); ?>
				<label for="attribute" class="control-label">Profile Group</label>
				 <?php $value = (isset($lead) ? $lead->profile_group : ''); ?>
				<select name="profile_group" class="form-control">
					<option value="">---Select---</option>
					<option value="Consulting" <?php echo ($value == 'Consulting' ? 'selected' : ''); ?>>Consulting</option>
					<option value="Infertility Tests" <?php echo ($value == 'Infertility Tests' ? 'selected' : ''); ?>>Infertility Tests</option>
					<option value="Natural" <?php echo ($value == 'Natural' ? 'selected' : ''); ?>>Natural</option>
					<option value="IUI" <?php echo ($value == 'IUI' ? 'selected' : ''); ?>>IUI</option>
					<option value="ICSI" <?php echo ($value == 'ICSI' ? 'selected' : ''); ?>>ICSI</option>
					<option value="IVF" <?php echo ($value == 'IVF' ? 'selected' : ''); ?>>IVF</option>
					<option value="Surrogacy" <?php echo ($value == 'Surrogacy' ? 'selected' : ''); ?>>Surrogacy</option>
				</select>
                <?php if (!is_language_disabled()) { ?>
                <div class="form-group">
