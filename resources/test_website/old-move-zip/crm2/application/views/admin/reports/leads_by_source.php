                    ...
                    <div class="panel-body panel-table-full">
                        <div class="row">
                            <div class="col-md-1">
                                ...
                                <a download="leads_by_source-<?=$monthName."-".$year?>.xls" class="btn btn-default mright10" href="#" onclick="return ExcellentExport.excel(this, 'leads-by-source-table', 'Leads by Source Report <?php echo $monthName."-".$year; ?>');"><i class="fa-regular fa-file-excel"></i></a>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed" id="leads-by-source-table">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$sum[] = $res->total; $sname = $sources[$key]['name']; $sour[$sname][] = $res->total; ?></td>
                                        <?php } ?>
                                        <td><?=array_sum($sum)?></td>
                                    </tr>
                                    <?php $sum = []; } ?>
                                ...
                                <tfoot>
                                    <tr style="font-weight:700">
                                        ...
                                        <?php foreach($sources as $source){ $name = $source['name']; ?>
                                        <td><?=$net[] = array_sum($sour[$name])?></td>
                                        <?php } ?>
                                        <td><?=array_sum($net)?></td>
                                    </tr>
                                </tfoot>
...
$('select[name="month"]').on('change', function() {
    window.location = admin_url+'reports/leads_by_source/' + $('select[name="month"]').val()+'/'+ $('#year').val();
});
</script>
</body>
