...
$('select[name="month"]').on('change', function() {
    window.location = admin_url+'reports/telecaller_performance_by_location/' + $('select[name="month"]').val()+'/'+ $('#year').val();
});
$('.overall').on('click', function() {
    window.location = admin_url+'reports/telecaller_performance_by_location/0/0/overall';
});
</script>
</body>
