...
<div id="header">
    ...
    <nav class="tw-flex tw-justify-between">
        ...
        <div class="mobile-menu">
            ...
            <div class="mobile-navbar collapse" id="mobile-collapse" aria-expanded="false" style="height: 0px;"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <?php /*<li class="header-my-timesheets"><a href="<?php echo admin_url('staff/timesheets'); ?>">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <?php /*<li class="icon header-timers timer-button tw-relative ltr:tw-mr-1.5 rtl:tw-ml-1.5" data-placement="bottom"
