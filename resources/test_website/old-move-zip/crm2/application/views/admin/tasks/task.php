            ...
            <div class="modal-body">
                <div class="row">
                  ...
                  ?>
                        ...
                        <div class="checkbox checkbox-primary checkbox-inline task-add-edit-billable tw-pt-2" style="display:none">
                     ...
                     if ($this->input->get('ticket_to_task')) {
                        ...
                        <div style="display:none" class="task-hours<?php if (isset($task) && $task->rel_type == 'project' && total_rows(db_prefix() . 'projects', ['id' => $task->rel_id, 'billing_type' => 3]) == 0) {
                      echo ' hide';
                  } ?>">
