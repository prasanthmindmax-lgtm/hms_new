...
<div id="wrapper">
                        ...
                        <div class="tab-content tw-mt-5">
                            <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                              ...
                              ?>
                                ...
                                <div class="form-group" >
                                    <label for="skype" class="control-label">Call Type</label>
                                    <div class="checkbox checkbox-primary">
                                        <input type="radio" value="Exotel" name="call_type" <?php if($member->call_type == 'Exotel'){ echo "checked"; } ?> id="exotel">
                                        <label for="exotel">Exotel</label>
                                    </div>
                                    <div class="checkbox checkbox-primary">
                                        <input type="radio" value="Knowlarity" name="call_type" <?php if($member->call_type == 'Knowlarity'){ echo "checked"; } ?> id="knowlarity">
                                        <label for="knowlarity">Knowlarity</label>
                                    </div>
                                    <div class="checkbox checkbox-primary">
                                        <input type="radio" value="Disabled" name="call_type" <?php if($member->call_type == 'Disabled'){ echo "checked"; } ?> id="disabled">
                                        <label for="disabled">Call Disabled</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="call_no" class="control-label">Call Number</label>
                                    <input type="number" class="form-control" id="call_no" value="<?=$member->call_no?>" name="call_no" />
                                </div>
                                ...
                                <?php } ?>
                                <i style="display:none" class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1"
                                    data-toggle="tooltip"
    ...
    $(document).on('click', '#inbound_call', function() {
        if(this.checked){
            $('.inbound_display').show();   
        } else {
            $('.inbound_display').hide();
        }
    })
    </script>
    </body>
