...
class Staff_model extends App_Model
{
     ...
     * @return array
     */
    public function getAgentMobile($id)
    {
        $this->db->where('staffid', $id);
    ...
    public function add($data)
    {
        ...
        /*** Vicky Add Staff Permission 04-01-2023 ***/
        $data['lead_status'] = $data['lead_status'] ? implode(',', $data['lead_status']) : null;
        $data['lead_source'] = $data['lead_source'] ? implode(',', $data['lead_source']) : null;
        $data['lead_location'] = $data['lead_location'] ? implode(',', $data['lead_location']) : null;
        $data['new_lead']       = $data['new_lead'] ? 1 : 0;
        $data['export_lead']    = $data['export_lead'] ? 1 : 0;
        $data['import_lead']    = $data['import_lead'] ? 1 : 0;
        $data['inbound_call']   = $data['inbound_call'] ? 1 : 0;
        $data['exotel']         = $data['exotel'] ? 1 : 0;
        $data['knowlarity']     = $data['knowlarity'] ? 1 : 0;
