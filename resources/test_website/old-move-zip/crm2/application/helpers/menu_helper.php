...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (has_permission('reports', '', 'view')) {
        ...
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'leads-monthly-performance-reports',
            'name'     => _l('als_lead_monthly_submenu'),
            'href'     => admin_url('reports/leads_monthly_performance'),
            'position' => 35,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'leads-by-location-reports',
            'name'     => _l('als_lead_by_location_submenu'),
            'href'     => admin_url('reports/leads_by_location'),
            'position' => 40,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'leads-by-source-reports',
            'name'     => _l('als_lead_by_source_submenu'),
            'href'     => admin_url('reports/leads_by_source'),
            'position' => 45,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'leads-by-status-reports',
            'name'     => _l('als_lead_by_status_submenu'),
            'href'     => admin_url('reports/leads_by_status'),
            'position' => 50,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'leads-by-location-status-reports',
            'name'     => _l('als_lead_by_location_status_submenu'),
            'href'     => admin_url('reports/leads_by_location_status'),
            'position' => 55,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'leads-by-campaigner-reports',
            'name'     => 'Leads by campaigner',
            'href'     => admin_url('reports/leads_by_campaigner'),
            'position' => 60,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'leads-by-campaigner-performance-reports',
            'name'     => 'Leads by campaigner performance',
            'href'     => admin_url('reports/leads_by_campaigner_performance'),
            'position' => 65,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'telecaller-performance-by-status-reports',
            'name'     => 'Telecaller performance by Status',
            'href'     => admin_url('reports/telecaller_performance_by_status'),
            'position' => 70,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'telecaller-performance-by-location-reports',
            'name'     => 'Telecaller performance by Location',
            'href'     => admin_url('reports/telecaller_performance_by_location'),
            'position' => 75,
            'badge'    => [],
        ]);
		
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'telecaller-activity-report',
            'name'     => 'Telecaller Activity Report',
            'href'     => admin_url('reports/telecaller_activity_report'),
            'position' => 75,
            'badge'    => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'walkin-schedule-by-location-reports',
            'name'     => 'Walkin Schedule by Location',
            'href'     => admin_url('reports/walkin_schedule_by_location'),
            'position' => 80,
            'badge'    => [],
        ]);
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'walkin-schedule-by-done-reports',
            'name'     => 'Walkin done by Location',
            'href'     => admin_url('reports/walkin_schedule_by_done'),
            'position' => 80,
            'badge'    => [],
        ]);
		$CI->app_menu->add_sidebar_children_item('reports', [
            'slug'     => 'location-performance-report',
            'name'     => 'Location Performance Report',
            'href'     => admin_url('reports/location_performance_report'),
            'position' => 85,
            'badge'    => [],
        ]);
    }
    ...
    if (is_admin()) {
        ...
        $CI->app_menu->add_setup_menu_item('campaigner', [
            'href'     => admin_url('campaigners'),
            'name'     => _l('acs_campaigner'),
            'position' => 60,
            'badge'    => [],
        ]);
