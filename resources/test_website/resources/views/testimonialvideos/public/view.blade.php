	...
	<div class="table-container" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Embedded Url', (isset($fields['embedded_url']['language'])? $fields['embedded_url']['language'] : array())) }}</td>
						<td>{{ $row->embedded_url}} </td>
