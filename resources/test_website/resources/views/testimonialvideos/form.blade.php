...
<div class="card">
	...
	{!! Form::open(array('url'=>'testimonialvideos?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Testimonial Videos</legend>
				{!! Form::hidden('id', $row['id']) !!}					
				           ...
				           >{{ $row['description'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Embedded Url" class=" control-label col-md-4 "> Embedded Url </label>
										<div class="col-md-8">
				           ...
				           >{{ $row['youtube_url'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										...
										@if(isset($row['image'])) {!! SiteHelpers::showUploadedFile( $row['image'],"/uploads/testimonialvideos/") !!} @endif
										</div>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("testimonialvideos/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
