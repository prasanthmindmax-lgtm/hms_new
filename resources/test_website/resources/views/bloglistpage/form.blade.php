...
<div class="card">
	<div class="card-body">
		...
		{!! Form::open(array('url'=>'bloglistpage?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
		...
		<script type="text/javascript">
			$(document).ready(function() { 
				...
				$('.removeMultiFiles').on('click',function(){
					var removeUrl = '{{ url("bloglistpage/removefiles?file=")}}'+$(this).attr('url');
					$(this).parent().remove();
