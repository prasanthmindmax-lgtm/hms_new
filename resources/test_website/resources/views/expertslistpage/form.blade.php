...
<div class="card">
	...
	{!! Form::open(array('url'=>'expertslistpage?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Experts list page</legend>
				...
				?>					
						     ...
						     class='form-control form-control-sm ' /> 
									...
									<div class="form-group row  " >
										...
										@if(isset($section1['banner_image'])) {!! SiteHelpers::showUploadedFile( $section1['banner_image'],"/uploads/experts/") !!} @endif
										</div>
									...
									<!-- section 1 end -->			
									  <div class="form-group row  " >
										...
										<div class="col-md-8">
										  <select name='section_2[]' multiple rows='5' id='section_2' class='select2 '   ></select> 
										 </div> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-8">
										  <select name='section_3[]' multiple rows='5' id='section_3' class='select2 '   ></select> 
										 </div> 
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#section_2").jCombo("{!! url('expertslistpage/comboselect?filter=tb_fertility_experts:id:name') !!}",
		{  selected_value : '{{ $row["section_2"] }}' });
		
		$("#section_3").jCombo("{!! url('expertslistpage/comboselect?filter=tb_fertility_experts:id:name') !!}",
		{  selected_value : '{{ $row["section_3"] }}' });
		 	
		 	 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("expertslistpage/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
