...
<div class="card">
	...
	{!! Form::open(array('url'=>'faqpage?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Faq page</legend>
				{!! Form::hidden('id', $row['id']) !!}	
						     ...
						     class='form-control form-control-sm ' /> 
									...
									<div class="form-group row  " >
										...
										@if(isset($banner_section['banner_image'])) {!! SiteHelpers::showUploadedFile( $banner_section['banner_image'],"/uploads/faq/") !!} @endif
										</div>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("faqpage/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
