...
<body>
    ...
    <header @if($inner_header == 1) class="inner-header" @endif>
       ...
       <ul class="navbar-nav ">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Female Fertility</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">In Vitro Fertilization (IVF)</a></li>
                            <li><a class="dropdown-item" href="#">Intrauterine Insemination (IUI)</a></li>
                            <li><a class="dropdown-item" href="#">Intracytoplasmic Sperm Injection (ICSI)</a></li>
                            <li><a class="dropdown-item" href="#">Frozen Embryo Transfer</a></li>
                            <li><a class="dropdown-item" href="#">Hysteroscopy</a></li>
                            <li><a class="dropdown-item" href="#">Blastocyst Culture And Transfer</a></li>
                            <li><a class="dropdown-item" href="#">Laser Assisted Hatching (LAH)</a></li>
                            <li><a class="dropdown-item" href="#">Laparoscopy for Infertility</a></li>
                        </ul>
                    </li>
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Male Fertilitys</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">PESA & TESA</a></li>
                            <li><a class="dropdown-item" href="#">Semen Freezing</a></li>
                            <li><a class="dropdown-item" href="#">Varicocele</a></li>
					...
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Advance Treatments</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Sequential Transfer</a></li>
                            <li><a class="dropdown-item" href="#">Endometrial Rejuvenation</a></li>
                            <li><a class="dropdown-item" href="#">DNA Fragmentation Index (DFI)</a></li>
                            <li><a class="dropdown-item" href="#">Micro TESE</a></li>
                            <li><a class="dropdown-item" href="#">Artificial Intelligence Embryo Selection</a></li>
                            <li><a class="dropdown-item" href="#">Preimplantation Genetic Testing (PGT-A)</a></li>
                            <li><a class="dropdown-item" href="#">Paternal Lymphocyte Immunization (PLI)</a></li>
                            <li><a class="dropdown-item" href="#">Magnetic Activated Cell Sorting (MACS)</a></li>
                            
                        </ul>
                    </li>
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Infertility Assessment</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Infertility Workup</a></li>
                            <li><a class="dropdown-item" href="#">Semen Analysis</a></li>
                            <li><a class="dropdown-item" href="#">Sonography Test</a></li>
                            <li><a class="dropdown-item" href="#">Doppler Tests & Urological Procedures</a></li>
                        </ul>
                    </li>
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Donor Programme</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Sperm Donor</a></li>
                            <li><a class="dropdown-item" href="#">Egg Donor</a></li>
                            <li><a class="dropdown-item" href="#">Embryo Donor</a></li>
                            <li><a class="dropdown-item" href="#">Surrogacy</a></li>
                        </ul>
                    </li>
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Infertility Consultation</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Ovulation Induction & Cycle Monitoring</a></li>
                            <li><a class="dropdown-item" href="#">Natural Pregnancy</a></li>
                            <li><a class="dropdown-item" href="#">Infertility Counselling</a></li>
					...
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Fertility Preservation</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Embryo Freezing (Cryopreservation)</a></li>
                            <li><a class="dropdown-item" href="#">Egg Freezing</a></li>
                        </ul>
                    </li>
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Infertility Technologies</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Time Lapse Embryo Monitoring</a></li>
                            <li><a class="dropdown-item" href="#">Laser Assisted Hatching (LAH)</a></li>
                            <li><a class="dropdown-item" href="#">Preimplantation Genetic Screening & Diagnosis  </a></li>
                            <li><a class="dropdown-item" href="#">Sperm DNA Fragmentation</a></li>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-sm-8">
                <li><a class="dropdown-item" href="{{url('location/chennai-sholinganallur')}}">Sholinganallur, Chennai</a></li>
            ...
            <div class="col-sm-6">
                ...
                <li><a class="dropdown-item" href="#">Tanjore</a></li>
                <li><a class="dropdown-item" href="#">Madurai</a></li>
				 ...
				 {{--<ul class="dropdown-menu">
					 ...
					 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Kerala</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('location/kerala-palakkad')}}">Palakkad</a></li>
                            <li><a class="dropdown-item" href="{{url('location/kerala-kozhikode')}}">Kozhikode</a></li>
                        </ul>
                    </li>
					 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Karnataka</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Electronic City, Bengaluru</a></li>
                            <li><a class="dropdown-item" href="{{url('location/Bengaluru')}}">Konanakunte, Bengaluru</a></li>
                        </ul>
                    </li>
					 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">International</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{url('location/srilanka')}}">Sri lanka</a></li>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				 ...
				 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle1" href="#">Patient Testimonial</a></li>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle1" href="#">Clinical Fellowship</a></li>
				 </ul>
				 </li>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle1" href="#">About Dr Aravind's IVF</a></li>
				 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Why Dr Aravind's IVF?</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Affordable Infertility Treatments</a></li>
					...
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle1" href="#">Award & Recognitions</a></li>
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle1" href="#">Our Fertility Experts</a></li>
