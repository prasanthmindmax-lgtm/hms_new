    ...
    <header @if($inner_header == 1) class="inner-header" @endif>
       ...
       <ul class="navbar-nav ">
            ...
            <div class="col-sm-8">
                ...
                <li><a class="dropdown-item" href="#">Chennai - Vadapalani (Coming soon)</a></li>
            ...
            <div class="col-sm-6">
                ...
                <li><a class="dropdown-item" href="#">Kallakurichi (Coming soon)</a></li>
                <li><a class="dropdown-item" href="#">Vellore (Coming soon)</a></li>
				 ...
				 {{--<ul class="dropdown-menu">
					 ...
					 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Karnataka</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Bengaluru - Hebbal (Coming soon)</a></li>
                        </ul>
                    </li>
