       ...
       <ul class="navbar-nav ">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					...
					<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Fertility Preservation</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Sperm Freezing</a></li>
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <li><a class="dropdown-item" href="{{url('location/harur')}}">Harur</a></li>
            </div>
            <div class="col-sm-6">
                ...
                <li><a class="dropdown-item" href="{{url('location/Tanjore')}}">Tanjore</a></li>
				 ...
				 {{--<ul class="dropdown-menu">
					 ...
					 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Karnataka</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('location/Bengaluru')}}">Electronic City, Bengaluru</a></li>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				 <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle1" href="{{ url('training') }}">Clinical Fellowship</a></li>
				 </ul>
				 </li>
				 <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				<li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle1" href="about-us">About Dr Aravind's IVF</a></li>
