...
<div class="card">
	...
	{!! Form::open(array('url'=>'trainingform?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Training Form</legend>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("trainingform/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
