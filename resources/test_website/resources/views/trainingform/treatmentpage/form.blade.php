...
<div class="card">
	...
	{!! Form::open(array('url'=>'treatmentpage?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Treatment page</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="banner_image-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["banner_image"],"/uploads/treatment/") !!}
						</div>
				           ...
				           >{{ $row['description'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Btn Title" class=" control-label col-md-4 "> Btn Title </label>
										<div class="col-md-8">
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Btn Link" class=" control-label col-md-4 "> Btn Link </label>
										<div class="col-md-8">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("treatmentpage/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
