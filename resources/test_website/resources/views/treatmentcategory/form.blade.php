...
<div class="card">
	...
	{!! Form::open(array('url'=>'treatmentcategory?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="">
		<div class="col-md-12">
						<fieldset><legend> Treatment category</legend>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("treatmentcategory/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
