		 ...
		 {!! Form::open(array('url'=>'nursingpage', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> Course Page</legend>
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Embryology Section" class=" control-label col-md-4 "> Embryology Section </label>
										<div class="col-md-8">
										  <input  type='text' name='embryology_section' id='embryology_section' value='{{ $row['embryology_section'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
