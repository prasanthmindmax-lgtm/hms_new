...
<div class="card">
	...
	{!! Form::open(array('url'=>'nursingpage?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("nursingpage/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
