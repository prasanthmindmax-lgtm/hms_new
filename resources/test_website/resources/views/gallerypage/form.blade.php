...
<div class="card">
	...
	{!! Form::open(array('url'=>'gallerypage?return='.$return, 'class'=>'form-horizontal  validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
		...
		<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}{!! Form::hidden('title', $row['title']) !!}	
									 ...
									 <div class="form-group row  " >
										<label for="banner-btn-name" class=" control-label col-md-4 ">Image name </label>
										<div class="col-md-8">
										  <input  type='text' name='title' id='title' class='form-control form-control-sm' value="@if(isset($row['title'])) {{ $row['title'] }}  @endif" /> 
										 </div> 
						...
						<div class="image-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["image"],"/uploads/gallery/") !!}
						</div>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("gallerypage/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
