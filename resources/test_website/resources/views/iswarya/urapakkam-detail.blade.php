...
<section id="banner" class="inner-banner overlay" style="background-image: url(../assets/iswarya/images/international/location-urappakkam.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                 <h1> Our IVF Centre in Abirami nagar, Urapakkam, Chennai</h1>
...
<section id="our-treatment" class="international">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="common-head-one text-center">Convenient IVF Centre Location in  Urapakkam
                </h2>
            ...
            <div class="col-md-12 col-lg-8">
                <div class="pink-box w-100">
                    <div class="d-flex justify-content-between">
                        <div class="left">
                            <h3>Iswarya IVF - Fertility & Pregnancy Centre in  Urapakkam</h3>
                            <p>
No 4, 2nd Floor, Grand Southern Trunk Rd, Abirami nagar, Urapakkam, Chennai, Tamil Nadu 603211
 </p>
...
No 4, 2nd Floor, 
Grand Southern Trunk Rd, Abirami nagar, 
Urapakkam, Chennai, 
Tamil Nadu 603211         </li>
                                    <li>
                                        <h6>Phone Number</h6>
                                        (+91) 90 2012 2012  
                                    </li>
