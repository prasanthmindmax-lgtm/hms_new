...
<section id="banner" class="inner-banner overlay" style="background-image: url(../assets/iswarya/images/international/location-erode.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1>Our IVF Centre in Kumalan Kuttai, Erode </h1>
...
<section id="our-treatment" class="international">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="common-head-one text-center">Convinent IVF Centre Location in Kumalan Kuttai, Erode
                </h2>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <p>Take a look at the treatments we offer to help you benefit the right results: </p>
                    <ul class="flower list-unstyled mb-0">
                        <li>Surrogacy</li>
                        <li>IVF</li>
                        <li>PGD</li>
                        ...
                        <p>We always the best approach to make sure that all your infertility problems are resolved. With us, you will always have an expert team by your side to make sure that the results are in your favor. Our team will assess all the problem in detail and then initiate with the work which can overcome all the situations and challenges and give you the beautiful gift of parenthood. So, you must not hesitate and get yourself connected to our team at the quickest to get started with the treatment right away.</p>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div id="gallery-erode" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                          <li data-target="#gallery-erode" data-slide-to="0" class="active"></li>
                          <li data-target="#gallery-erode" data-slide-to="1"></li>
                         <li data-target="#gallery-erode" data-slide-to="2"></li>

                        </ol>
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-4.jpg') }}" alt="First slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-5.jpg') }}" alt="Second slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-6.jpg') }}" alt="third slide">
                          </div>
