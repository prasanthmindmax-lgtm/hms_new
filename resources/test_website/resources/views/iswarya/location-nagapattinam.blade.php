...
<section id="banner" class="inner-banner overlay" style="background-image: url(assets/iswarya/images/international/location-chennai.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1>Our IVF Centre in Chennai</h1>
...
<section id="our-treatment" class="international">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="common-head-one text-center">Convenient IVF Centre Location in Chennai
                </h2>
            ...
            <div class="col-md-5">
                <div class="contact-box">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <h6>Address</h6>
                            Omalur Main Rd, Indirani Nagar, Narasothipatti, Chennai, Tamil Nadu 636304</p>
                        </li>
                        <li>
                            <h6>Phone Number</h6>
                            (+91) 90 2012 2012
                    ...
                    <div class="box">
                        ...
                        <a href="{{ url('Chennai/narasothipatti') }}" class="btn pink-btn ml-3">View Details</a>
