...
<section id="our-treatment" class="blogs">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <nav aria-label="breadcrumb">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">What is Infertility | It’s Causes & Treatment </li>
            ...
            <div class="col-md-8">
                <h2 class="mb-5">What is Infertility | It’s Causes & Treatment</h2>
                ...
                <img src="{{ asset('assets/iswarya/images/blog/b2.jpg') }}" alt="Blog" class="img-fluid">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-justify"> Infertility is a condition of reproductive health, where the couples are unable to conceive due to it, even after regular unprotected intercourse for a year or more. </p>
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-justify">
                                    ...
                                    Female infertility is a condition in which women are unable to conceive a pregnancy, even after a year or more than 6 months of trying. It can result due to physical, psychological or hormonal factors.
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-justify">
                                    ...
                                    Although fertility can be sustained for long, with the help of good diet and lifestyle changes, it cannot be cured. However, there are several advanced treatments that can help couples conceive pregnancy.
