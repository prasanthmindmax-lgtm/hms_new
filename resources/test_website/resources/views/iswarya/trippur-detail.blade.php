...
<section id="banner" class="inner-banner overlay" style="background-image: url(../assets/iswarya/images/international/location-tirupur.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1>Our IVF Centre in Anupparpalayam Pudur, Tiruppur </h1>
...
<section id="our-treatment" class="international">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="common-head-one text-center">Convenient IVF Centre Location in Tiruppur
                </h3>
            ...
            <div class="col-md-12 col-lg-8">
                <div class="pink-box w-100">
                    <div class="d-flex justify-content-between">
                        <div class="left">
                            <h3>Iswarya IVF - Fertility & Pregnancy Centre in Anupparpalayam Pudur, Tiruppur</h3>
                            <p> 
                           Avinashi Main Rd, Anupparpalayam Pudur, Tiruppur, Tamil Nadu 641652</p>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <p>Below mentioned are treatments we offer to help you out of the problem and experience the beautiful world of parenthood:</p>
                    <ul class="flower list-unstyled mb-0">
                         <li>Egg Donor</li>
                         <li>ICSI</li>
                         <li>Natural + OI</li>
                        ...
                        <p>When it comes to helping you with fertility-related issues, we have all the facilities to get rid of all the problems. Not only this, our team has the required experience and understanding to help you succeed in living your dream. We will check with all the aspects related to your infertility issues and design the treatment accordingly to give you the best gift of life. All our experts have the required know-how and experience you can trust upon and help yourself with the best of service.</p>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                       <!--  <div class="gallery-slider">
                           ...
                           <div id="gallery-trippur" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                          <li data-target="#gallery-trippur" data-slide-to="0" class="active"></li>
                          <li data-target="#gallery-trippur" data-slide-to="1"></li>
                          <li data-target="#gallery-trippur" data-slide-to="2"></li>
                        </ol>
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-10.jpg') }}" alt="First slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-11.jpg') }}" alt="Second slide">
                          </div>
                           <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-12.jpg') }}" alt="third slide">
                          </div>
                    ...
                    <div class="tab-pane fade" id="treatment" role="tabpanel" aria-labelledby="treatment-tab">
                        <div class="p-0" id="location">
                            ...
                            Avinashi Main Rd, Anupparpalayam Pudur,
