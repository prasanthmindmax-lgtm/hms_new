...
<section id="banner" class="inner-banner overlay" style="background-image: url(../assets/iswarya/images/international/location-hosur.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1>Our IVF Centre in Bagalur, Hosur </h1>
...
<section id="our-treatment" class="international">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="common-head-one text-center">Convenient IVF Centre Location in Bagalur, Hosur
                </h2>
            ...
            <div class="col-md-12 col-lg-8">
                <div class="pink-box w-100">
                    <div class="d-flex justify-content-between">
                        <div class="left">
                            <h3>Iswarya IVF - Fertility & Pregnancy Centre</h3>
                            <P> No 4/335, KVM Arcade, Bagalur Rd, Hosur, Tamil Nadu 635109</P>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <p>Take a look at the wide range of world-class treatments to assist you to conceive:</p>
                    <ul class="flower list-unstyled mb-0">
                    <li>IUI</li>
                    <li>Andrology</li>
                    <li>Natural + OI</li>
                    ...
                    <li>IMSI</li>
                        ...
                        <h4 class="sub-head">Our Stepped approach to Care</h4>
                        <p>We, at Iswarya Fertility will help you avail the best chance of living a parenthood life. We understand what it feels to be dealing with the problems of infertility. But, now we have the best solution to overcome this challenge in all aspects. Not only do we have the cutting edge facilities in place but we also have customized approach in the process which will give you the solution according to your specific needs. As soon as you connect with us, we only work to help you have your baby. We will always be by your side during the entire procedure. </p>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div id="gallery-kovai" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                          <li data-target="#gallery-kovai" data-slide-to="0" class="active"></li>
                          <li data-target="#gallery-kovai" data-slide-to="1"></li>
                         <li data-target="#gallery-kovai" data-slide-to="2"></li>
                        </ol>
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-1.jpg') }}">
                          </div>
                    ...
                    <div class="tab-pane fade" id="treatment" role="tabpanel" aria-labelledby="treatment-tab">
                        <div class="p-0" id="location">
                            <div class="contact-box w-100">
                                <h3>Iswarya IVF - Fertility & Pregnancy Centre in Bagalur, Hosur</h3>
                                <ul class="list-unstyled">
                                    <li>
                                        <h6>Address</h6>
                                       Iswarya IVF - Fertility & Pregnancy Centre<br>
                                    No 4/335, KVM Arcade, Bagalur Rd, Hosur, Tamil Nadu 635109
                                    </li>
                                    <li>
                                        <h6>Phone Number</h6>
                                        (+91) 90 2012 2012
