...
<section id="banner" class="inner-banner overlay" style="background-image: url(../assets/iswarya/images/international/location-chennai.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                 <h1> Our IVF Centre in Sholinganallur, Chennai </h1>
...
<section id="our-treatment" class="international">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="common-head-one text-center">Convenient IVF Centre Location in Sholinganallur
                </h2>
            ...
            <div class="col-md-12 col-lg-8">
                <div class="pink-box w-100">
                    <div class="d-flex justify-content-between">
                        <div class="left">
                            <h3>Iswarya IVF - Fertility & Pregnancy Centre in Sholinganallur</h3>
                            <p>
CJ Bros, No 493/3A, kalaigar karunanidi road, junction, Sholinganallur, Chennai, Tamil Nadu 600119 
 </p>
                    ...
                    <div class="tab-pane fade" id="treatment" role="tabpanel" aria-labelledby="treatment-tab">
                        <div class="p-0" id="location">
                            <div class="contact-box w-100">
                                <h3>Iswarya IVF - Fertility & Pregnancy Centre in Chennai</h3>
                                <ul class="list-unstyled">
                                    <li>
                                        <h6>Address</h6>
                                        
CJ Bros, No 493/3A, 
kalaigar karunanidi road, 
