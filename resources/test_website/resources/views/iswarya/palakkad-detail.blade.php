...
<section id="banner" class="inner-banner overlay" style="background-image: url(../assets/iswarya/images/international/location-palakkad.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1> Our IVF Centre in Kalvakulam, Mankavu, Palakkad  </h1>
                ...
                <div class="pink-box w-100">
                    <div class="d-flex justify-content-between">
                        <div class="left">
                            ...
                            Coimbatore Road, Palakkad – 678001</p>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                       <!--  <div class="gallery-slider">
                          ...
                          <div id="gallery-palakad" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators indicate" >
                          <li data-target="#gallery-palakad" data-slide-to="0" class="active"></li>
                          <li data-target="#gallery-palakad" data-slide-to="1"></li>
                        </ol>
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-16.jpg') }}" alt="First slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('assets/iswarya/images/gallery/g-17.jpg') }}" alt="Second slide">
                          </div>
