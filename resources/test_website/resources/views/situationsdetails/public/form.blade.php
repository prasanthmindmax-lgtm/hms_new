		 ...
		 {!! Form::open(array('url'=>'situationsdetails', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Answer" class=" control-label col-md-4 "> Answer </label>
										<div class="col-md-8">
