    ...
    <div class="qd-card">
      ...
      <div class="qd-header">
        <div class="qd-header-title">
          <i class="bi bi-diagram-3"></i> Expense Category Master
        </div>
        <div class="qd-header-actions">
          <button class="btn btn-primary btn-sm category_new">
            <i class="bi bi-plus-lg me-1"></i>New Expense Category
          </button>
        </div>
      </div>
      ...
      <div class="qd-search-row">
        <div class="qd-search-wrap">
          ...
          <input type="text" id="tableSearch" placeholder="Search expense category name...">
        </div>
      </div>
          ...
          <tbody>
            @forelse ($categories as $c)
              <tr class="qdt-row category-row" data-id="{{ $c->id }}" data-category='@json($c)'>
                ...
                <td>{{ $c->expenseType ? $c->expenseType->name : '-' }}</td>
                <td>
                  @if($c->is_active == 1)
            ...
            @empty
              <tr><td colspan="4" class="text-center py-5 text-muted">
                <i class="bi bi-inbox" style="font-size:2rem;display:block;margin-bottom:8px;"></i>No expense categories found
              </td></tr>
            @endforelse
          </tbody>
        </table>
...
<div class="sm-modal" id="categoryModal">
  <div class="sm-modal-box">
    <div class="sm-modal-header">
      <div class="sm-modal-title"><i class="bi bi-diagram-3" style="color:#4f6ef7;"></i> Expense Category</div>
    ...
    <div class="sm-form-row">
      <div class="sm-form-group">
        ...
        <input type="text" class="form-control name" placeholder="e.g. Materials, Other Expenses" autocomplete="off">
      </div>
    </div>
    <div class="sm-form-row">
        <div class="sm-form-group">
            <label>Expense Type <span style="color:red">*</span></label>
            <select class="form-control expense_type_id" id="expense_type_id">
...
$(document).ready(function () {
  ...
  $(document).on('click', '.category_save', function (e) {
    ...
    fd.append('expense_type_id', $('#expense_type_id').val());
