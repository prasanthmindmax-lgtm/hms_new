...
/* UTR cell should expand */
.utr_transcation_ids,.bank_utr_transcation_ids {
        ...
        <!-- [ Main Content ] start -->
              ...
              <div class="container" style="margin-top: -51px;">
                <div class="row g-4">
                    ...
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold" id="total_other_amt">0</h3>
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Total OTHERS</p>
                        </div>
                    </div>
                    <!-- Row 8 -->
                    <div class="col-md-1 col-sm-3">
                        ...
                        <div class="table-container">
                            <table class="tblvis">
                                <thead>
                                    ...
                                    <tr>
                                        <th>Cash</th> <th>Card</th> <th>Upi</th><th>Total card/Upi</th> <th>NEFT</th><th>Other</th><th>Total</th>
                                        <th>Date of collection</th> <th>Collection Amount</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title">Add Remark & Upload File</h5>
        <button type="button" class="btn-close" onclick="$('#dateModal').modal('hide')"></button>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="mb-2">
          ...
          <textarea id="remark" class="form-control" rows="3"
...
<!-- <div class="modal fade" id="uploadModal" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title">Upload Deposit Documents</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="saveUploads">
          Save
        </button>
        <button type="button" class="btn btn-secondary" onclick="$('#uploadModal').modal('hide')">
        Close
        </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info">
                    ...
                    Click "Add Files" to browse and select files for this field.
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm" id="filePreviewTable">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>File Name</th>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="saveUploads">
                    <i class="fa fa-check"></i> Save Files
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="saveUploads">
                    <i class="fa fa-check me-1"></i> Save All Files
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="filePreviewModal" style="z-index:999999;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5>File Preview</h5>
            ...
            <div class="modal-body">
                ...
                <!-- 🔴 THIS is where preview must go -->
                <div id="filePreviewBody"></div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-success" id="downloadFileBtn">Download</button>
                <button class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- MANUAL ENTRIES -->
                <h6 class="mb-3">Manual Entries</h6>

                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Radiant Cash Collection</label>
                            <input type="file" name="collection_amount_files[]" multiple
                                class="form-control upload-input" data-preview="cash_preview">
                            <div class="preview-box" id="cash_preview"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="upload-section">
                            ...
                            <input type="file" name="deposit_amount_files[]" multiple
                                class="form-control upload-input" data-preview="deposit_preview">
                            <div class="preview-box" id="deposit_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>MESPOS Card</label>
                            <input type="file" name="mespos_card_files[]" multiple
                                class="form-control upload-input" data-preview="mespos_card_preview">
                            <div class="preview-box" id="mespos_card_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>MESPOS UPI</label>
                            <input type="file" name="mespos_upi_files[]" multiple
                                class="form-control upload-input" data-preview="mespos_upi_preview">
                            <div class="preview-box" id="mespos_upi_preview"></div>
                        </div>
                    </div>
                </div>
                ...
                <!-- BANK ENTRIES -->
                <h6 class="mb-3">Bank Entries</h6>

                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Bank Charges</label>
                            <input type="file" name="bank_chargers_files[]" multiple
                                class="form-control upload-input" data-preview="bank_charges_preview">
                            <div class="preview-box" id="bank_charges_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Bank UPI / Card</label>
                            <input type="file" name="bank_upi_card_files[]" multiple
                                class="form-control upload-input" data-preview="bank_upi_card_preview">
                            <div class="preview-box" id="bank_upi_card_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Bank NEFT</label>
                            <input type="file" name="bank_neft_files[]" multiple
                                class="form-control upload-input" data-preview="bank_neft_preview">
                            <div class="preview-box" id="bank_neft_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Bank Others</label>
                            <input type="file" name="bank_others_files[]" multiple
                                class="form-control upload-input" data-preview="bank_others_preview">
                            <div class="preview-box" id="bank_others_preview"></div>
                        </div>
                    </div>
                </div>
                ...
                <!-- UTR DOCUMENTS -->
                <h6 class="mb-3">UTR Documents</h6>

                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Cash UTR</label>
                            <input type="file" name="cash_utr_files[]" multiple
                                class="form-control upload-input" data-preview="utr_cash_preview">
                            <div class="preview-box" id="utr_cash_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Card / UPI UTR</label>
                            <input type="file" name="card_upi_utr_files[]" multiple
                                class="form-control upload-input" data-preview="utr_card_upi_preview">
                            <div class="preview-box" id="utr_card_upi_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>NEFT UTR</label>
                            <input type="file" name="neft_utr_files[]" multiple
                                class="form-control upload-input" data-preview="utr_neft_preview">
                            <div class="preview-box" id="utr_neft_preview"></div>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="upload-section">
                            <label>Others UTR</label>
                            <input type="file" name="other_utr_files[]" multiple
                                class="form-control upload-input" data-preview="utr_others_preview">
                            <div class="preview-box" id="utr_others_preview"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button class="btn btn-primary" id="saveUploadsfile">Save</button>
            </div>
...
<div class="modal fade" id="utrModal" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            
            <div class="modal-header">
                <h5 class="modal-title">UTR / Transaction Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <div class="modal-body">
                <div class="mb-3">
                    <label>UPI / CARD UTR No</label>
                    <input type="text" class="form-control" id="upi_utr">
                </div>

                <div class="mb-3">
                    <label>NEFT UTR No</label>
                    <input type="text" class="form-control" id="neft_utr">
                </div>

                <div class="mb-3">
                    <label>OTHERS UTR No</label>
                    <input type="text" class="form-control" id="others_utr">
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveUtrBtn">
                    Save
                </button>
            </div>
...
<script src="{{ asset('/assets/income_new/Income_reconciliation.js') }}"></script>
