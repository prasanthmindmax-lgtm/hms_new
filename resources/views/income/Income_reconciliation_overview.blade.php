...
.allign{
 ...
 .reconciliation-section {
    ...
    /* MocDoc/Branch modal: clickable amount (attachment) and branch */
    .amount-with-attachment {
        cursor: pointer;
        text-decoration: underline;
        color: #0d6efd !important;
    }
    .amount-with-attachment:hover {
    ...
    .utr-with-attachment:hover {
        color: #0a58ca !important;
    }
    /* UTR column: fixed width + wrap in both MocDoc modals */
    #mocdocModal .mocdoc-utr-cell,
    #mocdocBranchModal .mocdoc-utr-cell {
        max-width: 220px;
        min-width: 120px;
        word-break: break-word;
        white-space: normal;
    ...
    #mocdocModal .table .mocdoc-utr-cell,
    #mocdocBranchModal .table .mocdoc-utr-cell {
          ...
          <div class="row ">
            <div class="col-md-12 col-sm-12" style="display: flex;justify-content: space-between;">
                ...
                <div style="display:flex;gap: 10px;height: 35px;">
                        <a href="{{ route('superadmin.indexNew') }}" class="btn btn-primary btn-sm">+ New</a>
                        {{-- <div style="text-align: right;">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#importbillModal">Import Bill</a></li>
              ...
              <div class="container-fluid px-4" style="margin-top: -20px;">
                ...
                <div class="reconciliation-section mb-2">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-click" data-type="bank_chargers">
                                <div class="stat-header">
                                    <i class="fas fa-wallet text-secondary"></i>
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-click" data-type="bank_upi_card">
                                <div class="stat-header">
                                    <i class="fas fa-wallet text-secondary"></i>
                                    <span class="stat-label">Total UPI/Card</span>
                                </div>
                ...
                <div class="reconciliation-section mb-3">
                    ...
                    <div class="row g-2">
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-diff stat-click" data-type="cash_diff">
                                <div class="stat-header">
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-diff stat-click" data-type="card_diff">
                                <div class="stat-header">
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-diff stat-click" data-type="neft_diff">
                                <div class="stat-header">
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-diff stat-click" data-type="upi_diff">
                                <div class="stat-header">
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-diff stat-click" data-type="other_diff">
                                <div class="stat-header">
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-diff stat-click" data-type="total_upicard_diff">
                                <div class="stat-header">
                                    <i class="fas fa-exchange-alt text-secondary"></i>
                                    <span class="stat-label">Total UPI/Card</span>
                                </div>
                        ...
                        <div class="col-lg col-md-4 col-sm-6">
                            <div class="stat-card stat-total stat-diff stat-click" data-type="amount_diff">
                                <div class="stat-header">
...
<div class="modal fade" id="mocdocModal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content" >
      ...
      <div class="modal-header" >
        <h5 class="modal-title" id="mocdocModalTitle"></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <div class="modal-body" style="max-height:500px;overflow:auto;">
        <div id="mocdocModalBranchTotals" class="mb-3"></div>
...
<!-- Branch-wise detail modal (opens when branch is clicked in main modal) -->
<div class="modal fade" id="mocdocBranchModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="mocdocBranchModalTitle"></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body" style="max-height:500px;overflow:auto;">
        <table class="table table-bordered table-striped">
            <thead id="mocdocBranchModalHead"></thead>
            <tbody id="mocdocBranchModalBody"></tbody>
        </table>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
	...
	const dateOverviewIncomeUrl = "{{ route('superadmin.incomeOverviewDateFilter') }}";
	const incomeOverviewDatafitter = "{{ route('superadmin.overviewdata') }}";
