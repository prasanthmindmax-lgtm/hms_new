...
/* Show the tooltip when hovering over either the icon or the tooltip itself */
...
ul li label {
  ...
  <body style="overflow-x: hidden;">
    ...
    <!-- [ Sidebar Menu ] start -->
    @include('staff.superadminnav')
<!-- [ Sidebar Menu ] end -->
<!-- [ Header Topbar ] start -->
    @include('staff.superadminheader')  
...
<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-options multi_search options_marketrs marketernameall">
									 @if($user_name)
                        ...
                        <div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-options multi_search options_marketrs brachviewsall">
                                       @if($location)
...
@php $zones = App\Models\TblZonesModel::select('name')->get(); @endphp 
                        <div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-options multi_search options_marketrs zoneviewsall">
                                         @if($zones)
						...
						<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search marketervalues_search" name="department.depart_name" id="deprt_search" placeholder="Select Dept" autocomplete="off">
                                    <div class="dropdown-options multi_search options_marketrs dept_views">
                                        @if($categories)
...
<span style="cursor: pointer;" id="created_by_search" class="badge bg-success value_views_minsearch"></span>
<span style="cursor: pointer;" id="branch_search" class="badge bg-success value_views_minsearch"></span>
<span style="cursor: pointer;" id="zone_search" class="badge bg-success value_views_minsearch"></span>
<span style="cursor: pointer;" id="depart_search" class="badge bg-success value_views_minsearch"></span>
                ...
                <div class="card">
                    ...
                    <div class="scroll-block position-relative">
                        ...
                        <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-12">
												...
												<!--<details class="form-control">
													<summary style="height: 11px;">Select Ticket Status</summary>
													<ul>
														
														@if($statuses)
															@foreach ($statuses as $status)
															<li style="padding: 4px 2px;">
																<label for="bmw">{{ $status->status_name}}<input type="checkbox" class="statusCheckbox"
												...
												<!--<details class="form-control">
													...
													<ul>
														...
														@if($priorities)
															@foreach ($priorities as $priority)
															<li style="padding: 4px 2px;">
																<label for="bmw">{{ $priority->priority_name}}<input type="checkbox" class="priorityCheckbox"
                                    ...
                                    <!--<div class="col-sm-12">
                                        <div class="mb-12"><br>
												<label class="form-label required" style="font-size: 12px;font-weight: 600;">Select Date</label>
												<select class="form-control morefittersclr" name="date_type" id="dateType" style="line-height:1">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12" id="start_date"><br>
												<label class="form-label required" style="font-size: 12px;font-weight: 600;">Start Date</label>
												<input type="date" class="form-control morefittersclr" name="start_date" id="startDate" style="height: 39.5px;"/>
											</div>
                                    </div>
									
                                    <div class="col-sm-12">
                                        <div class="mb-12" id="end_date"><br>
												<label class="form-label required" style="font-size: 12px;font-weight: 600;">End Date</label>
												<input type="date" class="form-control morefittersclr" name="end_date" id="endDate" style="height: 39.5px;"/>
											</div>
                                    </div>-->
                    ...
                    <div class="modal-content">
                        ...
                        <div id="error-message"></div>
                            ...
                            <div class="modal-body">
							 <form method="post" action="{{ route('staff.ticketadded') }}" name="demoform" id="demoform"  enctype="multipart/form-data">
							@csrf
                                ...
                                <div class="row">                                    
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <!--<select class="mb-3 form-select" id="location" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="location_id">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                           ...
                                           <!-- <select class="mb-3 form-select" id="department_id" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="department_id">
...
<script src="{{ asset('/assets/staff/ticket-details.js') }}"></script>
...
<script type="text/javascript">
	...
	const addedUrl = "{{ route('staff.ticketadded') }}";
    const ticketfetchUrl = "{{ route('staff.ticketfetch') }}";
    const ticketdatefillter = "{{ route('staff.ticketdatefillter') }}";
    const ticketfillter = "{{ route('staff.ticketfillter') }}";
    const fetchUrlmorefitter = "{{ route('staff.fetchticketfitter') }}";
    const fetchUrlticketfitterremove = "{{ route('staff.fetchticketfitterremove') }}";
...
$(document).on("click", function (event) {
  ...
  <script>
    ...
    <!-- [ Main Content ] end -->
    @include('staff.superadminfooter')
  </body>
  <!-- [Body] end -->
</html>
