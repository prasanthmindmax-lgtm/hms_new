...
<script>
  preset_change('preset-1');
    ...
    <script src="{{ asset('/assets/marketer/doctor-details.js') }}"></script>
    <script src="{{ asset('/assets/marketer/doctor-added.js') }}"></script>
    <script src="{{ asset('/assets/marketer/doctor-meeting.js') }}"></script>
    <script src="{{ asset('/assets/marketer/doctor-patient.js') }}"></script>
    <script src="{{ asset('/assets/marketer/referral_info.js') }}"></script>
    <script src="{{ asset('/assets/branch/branch.js') }}"></script>

    <script>
 const addedUrl = "{{ route('referral.doctoradded') }}";
    const fetchUrl = "{{ route('referral.fetch') }}";
    const fetchUrlfitter = "{{ route('referral.fetchfitter') }}";
    const fetchUrlmorefitter = "{{ route('referral.fetchmorefitter') }}";
    const fetchUrlmorefitterremove = "{{ route('referral.fetchmorefitterremove') }}";
    const fetchUrlmorefitterdate = "{{ route('referral.fetchmorefitterdate') }}";
    const fetchUrlmorefitterdateclear = "{{ route('referral.fetchmorefitterdateclr') }}";
    const doctordetailseditsall = "{{ route('referral.doctordetailsedit') }}";
    const doctordetailsid = "{{ route('referral.doctordetailsid') }}";
    // meeting blade url in js .............................

    const meetingfetch = "{{ route('referral.meetingid') }}";
    const meetinginsert = "{{ route('referral.meetinginsert') }}";
    const meetingviews="{{ route('referral.meetingallviews') }}";
    const meetingdatefitter="{{ route('referral.meetingdatefitter') }}";
    const meetingmorefitter="{{ route('referral.meetingmorefitter') }}";
    const meetingremovefitter="{{ route('referral.meetingremovefitter') }}";
    const meetingclrfitter="{{ route('referral.meetingclrfitter') }}";
    const meetingdateandfitter="{{ route('referral.meetingdateandfitter') }}";
    const branchfetchviews = "{{ route('referral.branchfetchviews') }}";
    const zonefetchviews = "{{ route('referral.zonefetchviews') }}";
    const marketernamesurls = "{{ route('referral.marketernamesurls') }}";

    // End meeting blade url in js ...........................

        // patient blade url in js .............................

        const patientfetch = "{{ route('referral.patientid') }}";
    const patientinsert = "{{ route('referral.patientinsert') }}";
    const patientviews="{{ route('referral.patientallviews') }}";
    const patientdatefitter="{{ route('referral.patientdatefitter') }}";
    const patientmorefitter="{{ route('referral.patientmorefitter') }}";
    const patientremovefitter="{{ route('referral.patientremovefitter') }}";
    const patientclrfitter="{{ route('referral.patientclrfitter') }}";
    const patientdateandfitter="{{ route('referral.patientdateandfitter') }}";

    // End patient blade url in js ...........................

    const patientpop="{{ route('referral.patientpop') }}";
    const meetingpop="{{ route('referral.meetingpop') }}";
