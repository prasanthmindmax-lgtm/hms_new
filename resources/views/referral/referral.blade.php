...
@include('referral.superadminhead')
<!-- [Head] end -->
<!-- [Body] Start -->
...
<body style="overflow-x: hidden;">
    ...
    <!-- [ Sidebar Menu ] start -->
    @include('referral.superadminnav')
    <!-- [ Sidebar Menu ] end -->
    <!-- [ Header Topbar ] start -->
    @include('referral.superadminheader')
    <!-- [ Header ] end -->
    <!-- [ Main Content ] start -->
...
"><i class="ti ti-plus f-18"></i> Add Doctor</a>
                        ...
                        <div class="col-md-3 col-sm-3 add-meeting">
                            <a href="#" class="btn btn-outline-primary d-inline-flex align-items-center gap-2 addmeeting" data-bs-toggle="modal" data-bs-target="#customer-edit_add-modal" style="
       height: 34px;
    width: 133px;
    font-size: 12px;
"><i class="ti ti-plus f-18"></i>Meeting</a>
                        ...
                        <div class="col-md-3 col-sm-3 add-patient">
                            <a href="#" class="btn btn-outline-primary d-inline-flex align-items-center gap-2 addpatient" data-bs-toggle="modal" data-bs-target="#customer-edit_add-modal" style="
       height: 34px;
    width: 133px;
    font-size: 12px;
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            ...
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Total Doctors</p>
                        </div>
                    </div>
                    <!-- Row 2 -->
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            ...
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Total Meetings</p>
                        </div>
                    </div>
                    <!-- Row 3 -->
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            ...
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Total Patients</p>
                        </div>
                    </div>
                </div><br>
            </div>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="analytics-tab-1-pane" role="tabpanel" aria-labelledby="analytics-tab-1" tabindex="0">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xl-3" style="width: 58%;">
                                ...
                                <table class="tbl">
                                    <thead class="thd">
                                        <tr class="trview">
                                            ...
                                            <th class="thview">Contact number</th>
                ...
                <div class="tab-pane fade" id="analytics-tab-2-pane" role="tabpanel" aria-labelledby="analytics-tab-2" tabindex="0">
                    <div class="col-xl-12 col-md-12">
                        ...
                        <p style="
    margin-top: -9px;
" class="text-muted f-12 mb-0"><span class="text-truncate w-100"><span id="markmeetingcunt">0</span> Rows for <span id="meetingdatefitter">Last 30 days</span></span>
                ...
                <div class="tab-pane fade" id="analytics-tab-3-pane" role="tabpanel" aria-labelledby="analytics-tab-3" tabindex="0">
                    <div class="col-xl-12 col-md-12">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-md-2">
                                <div class="">
                                    <a href="#" class="btn btn-outline-primary d-inline-flex " data-bs-toggle="offcanvas" data-bs-target="#offcanvas_mail_filterpatient" style="
                                        height: 34px;
                                        width: 133px;
                                        font-size: 12px;
                                    "><i class="ti ti-filter f-18"></i>&nbsp; More filter</a>
...
" class="text-muted f-12 mb-0"><span class="text-truncate w-100"><span id="counts">0</span> Rows for <span id="patientviews">Last 30 days</span></span>
                            <span class="search_view_patient" style="color: #e40505;font-size: 12px;font-weight: 600;">Search :</span>
                                ...
                                <div class="scroll-block position-relative">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-12"><br>
                                          ...
                                          <input type="text" class="form-control morefittersclr" readonly id="employee_more" value="{{ $admin->username }}"  name="empolyee_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Marketer Name">
                                        </div>
                                    </div> -->
                                            <div class="col-sm-12">
                                                <div class="mb-12">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="empolyee_name" value=" {{ $admin->username }}" readonly name="empolyee_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Marketer Name">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="mb-3 form-select" id="special" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="special">
                                                    <option value="">Specialization</option>
                                                    <option value="Ayurvedic">Ayurvedic</option>
                                                    <option value="MBBS Doctors">MBBS Doctors</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                               ...
                                               <div class="dropdown">
                                    <input type="text" class="searchInput marketervalues_search_patient cityvalues" name="city" id="city"  placeholder="Select Branch">
                                    <div class="dropdown-options options_patient brachviewsall">
                                        <div data-value="1">chennai</div>
                                        <div data-value="2">Madurai</div>
                                        <div data-value="3">11811</div>
                                    </div>
                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" id="submit-doctor-datas" style="height: 34px;width: 133px;font-size: 12px;" class="btn btn-outline-primary">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="scroll-block position-relative">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <br><label class="form-label required" style="font-size: 12px;font-weight: 600;">city:</label>
  ...
  $(document).on("click", function (event) {
    if (!$(event.target).closest(".dropdown").length) {
      $(".dropdown").removeClass("active");
        ...
        <!-- [ Main Content ] end -->
        @include('referral.superadminfooter')
</body>
<!-- [Body] end -->
</html>