...
.dropdown {
    ...
    .dropdown-options div:hover {
        background-color: rgb(177 99 166);
        color: white;
    }
...
"><i class="ti ti-plus f-18"></i> New User</a></div>
          </div>
        </div>
      </div>
<!-- [ breadcrumb ] end -->
                ...
                <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      aria-selected="true">Manage users</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button
                      class="nav-link"
...
<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput marketervalues_search" name="userfullname" id="marketer_fetch" placeholder="Select role">
                                    <div class="dropdown-options options_marketers marketernameall">
...
<div class="col-xl-2 col-md-2">
<div class="">
<!-- <a href="#" class="btn btn-outline-primary d-inline-flex " data-bs-toggle="offcanvas" data-bs-target="#offcanvas_mail_filter"  style="
       height: 34px;
    width: 133px;
    font-size: 12px;
...
<div class="col-lg-3 col-xl-3" style="width: 16%;">
...
<span style="cursor: pointer;" class="badge bg-success " style="display:none;"></span>
        ...
        <table class="tbl">
            <thead class="thd">
                <tr class="trview">
                    ...
                    <th class="thview">User Name</th>
                    <th class="thview">Personal Details</th>
                    <th class="thview">Status</th>
                    <th class="thview">Date</th>
                    <th class="thview">Created By</th>
                </tr>
            </thead>
            <tbody id="usersdetails">
                <tr>
                </tr>
            </tbody>
        </table>
    ...
    <div class="footer">
        <div>
            Items per page:
            <select id="itemsPerPageSelectusers">
            <option>3</option>
            <option>5</option>
                <option>10</option>
                <option>15</option>
        ...
        <div  class="pagination" id="paginationusers" ></div>
    </div>
              </div>
          </div>
                </div>
...
<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput marketervalues_search_meeting" name="userfullname" id="meeting_mark" placeholder="Select role">
...
<div class="col-xl-2 col-md-2">
<div class="">
<!-- <a href="#" class="btn btn-outline-primary d-inline-flex " data-bs-toggle="offcanvas" data-bs-target="#offcanvas_mail_filternew"  style="
       height: 34px;
    width: 133px;
    font-size: 12px;
"><i class="ti ti-filter f-18"></i>&nbsp; More filter</a> -->
...
<div class="col-lg-3 col-xl-3" style="width: 16%;">
                ...
                <p style="
    margin-top: -9px;
" class="text-muted f-12 mb-0"><span class="text-truncate w-100"><span >0</span> Rows for <span id="">Last 30 days</span></span>
<span  style="color: #e40505;font-size: 12px;font-weight: 600;" class="search_meeting">Search :</span>
<span style="cursor: pointer;" class="badge bg-success "></span>
<span style="cursor: pointer;" class="badge bg-success "></span>
<span style="cursor: pointer;" class="badge bg-success "></span>
<span style="cursor: pointer;" class="badge bg-success "></span>
...
<span style="cursor: pointer; display:none;" class="badge bg-success " ></span>
        ...
        <table class="tbl">
            <thead class="thd">
                <tr class="trview">
                    ...
                    <th class="thview">Login ID</th>
                    <th class="thview">Department</th>
    ...
    <div class="offcanvas-body p-0">
                        ...
                        <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            ...
                                            <input type="text" class="form-control morefittersclr" id="doctornames_more"  name="doctor_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Doctor Name">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-12"><br>
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Marketer Name:</label>
                                            <select class="mb-3 form-select morefittersclr" id="employee_more" name="empolyee_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="empolyee_name">
                                 ...
                                 <input type="text" id="special_more" name="special" class="multiselect-input morefittersclr" placeholder="Select Specialization" readonly>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            ...
                                            <select class="mb-3 form-select morefittersclr" id="city_more"  style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="city">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            ...
                                            <input type="text" class="form-control morefittersclr" id="hospital_more" name="hopsital_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Clinic / Hospital Name">
                                        </div>
                                    </div>
                           </div>
                        </div>
        ...
        <a href="#" style="height: 34px;width: 133px; font-size: 12px;" id="morefitter_search" data-bs-dismiss="offcanvas" class="btn btn-outline-primary w-50">Submit</a>
    </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="scroll-block position-relative">
                        ...
                        <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Doctor Name:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_doctor errorss"></span>
                                            <input type="text" class="form-control morefittersclr_meeting" id="doctor_name_meeting"  name="doctor_name_meeting" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Doctor Name">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-12"><br>
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Marketer Name:</label>
                                            <select class="mb-3 form-select morefittersclr_meeting" id="employee_more_meeting" name="empolyee_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="empolyee_name">
                                            <option value="">Marketer</option>
                                            <option value="R. Anusuya">R. Anusuya</option>
                                            <option value="G. Aswin">G. Aswin</option>
                                            <option value="V.Soundarya">V.Soundarya</option>
                                 ...
                                 <input type="text" id="special_more_meeting" name="special" class="multiselect-input morefittersclr_meeting" placeholder="Select Specialization" readonly>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">city:</label>
                                            <select class="mb-3 form-select morefittersclr_meeting" id="city_more_meeting"  style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="city">
                                            <option value="">Select city</option>
                                            <option value="Chennai">Chennai</option>
                                            <option value="Tiruppur">Tiruppur</option>
                                            <option value="Salem">Salem</option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Clinic / Hospital Name:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_hplname errorss"></span>
                                            <input type="text" class="form-control morefittersclr_meeting" id="hospital_more_meeting" name="hopsital_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Clinic / Hospital Name">
                                        </div>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="scroll-block position-relative">
                        ...
                        <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Doctor Name:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_doctor errorss"></span>
                                            <input type="text" class="form-control morefittersclr_patient" id="doctor_name_patient"  name="doctor_name_meeting" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Doctor Name">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-12"><br>
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Marketer Name:</label>
                                            <select class="mb-3 form-select morefittersclr_patient" id="employee_more_patient" name="empolyee_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="empolyee_name">
                                            <option value="">Marketer</option>
                                            <option value="R. Anusuya">R. Anusuya</option>
                                            <option value="G. Aswin">G. Aswin</option>
                                            <option value="V.Soundarya">V.Soundarya</option>
                                 ...
                                 <input type="text" id="special_more_patient" name="special" class="multiselect-input morefittersclr_patient" placeholder="Select Specialization" readonly>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">city:</label>
                                            <select class="mb-3 form-select morefittersclr_patient" id="city_more_patient"  style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="city">
                                            <option value="">Select city</option>
                                            <option value="Chennai">Chennai</option>
                                            <option value="Tiruppur">Tiruppur</option>
                                            <option value="Salem">Salem</option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Clinic / Hospital Name:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_hplname errorss"></span>
                                            <input type="text" class="form-control morefittersclr_patient" id="hospital_more_patient" name="hopsital_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Clinic / Hospital Name">
                                        </div>
                                    </div>
                                </div>
                        </div>
...
<div class="col-sm-12">
                ...
                <div
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel" style="color: #ffffff;font-size: 12px;">New User</h5>
                        ...
                        <div id="error-message"></div>
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">User Name :</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_doctor errorss"></span>
                                            <input type="text" class="form-control" id="user_fullname" name="user_fullname" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="User Name">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Login ID / Name :</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_doctor errorss"></span>
                                            <input type="text" class="form-control" id="username" name="username" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="User ID">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Password :</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_doctor errorss"></span>
                                            <input type="text" class="form-control" id="password" name="password" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Password">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Role :</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_special errorss"></span>
                                            <select class="mb-3 form-select" id="role" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="role">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Email :</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_hplname errorss"></span>
                                            <input type="text" class="form-control" id="email" name="email" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="email_address">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Mobile :</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_adress errorss"></span>
                                            <input type="text" class="form-control" id="mobile" name="mobile" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="mobile">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <select class="mb-3 form-select" id="city" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" required name="city">
                                            <option value="">Select city</option>
                                            <option value="Chennai">Chennai</option>
                                            <option value="Tiruppur">Tiruppur</option>
                                            <option value="Salem">Salem</option>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="users-datas" style="height: 34px;width: 133px;font-size: 12px;" class="btn btn-outline-primary">Submit</button>
                                </div>
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Doctor Name:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_doctor errorss"></span>
                                            <select class="mb-3 form-select meetingschedule " id="meeting-doctorname" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"  name="doctor_name">
                                  ...
                                  <input type="hidden" class="form-control meetingschedule" id="hpl_contacts" name="hpl_contact" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" readonly placeholder="Hospital Contact Number">
                                    <div class="col-sm-12 ">
                                        <div class="mb-12">
                                            ...
                                            <textarea require class="form-control meetingschedule" id="additional-notes" name="meeting_feedback" rows="6" style="border-radius: 10px; border: solid 1px #d3d3d3; background-color: #fff; color: #505050 !important; width: 100%; padding: 6px;" placeholder="Enter feedback details here"></textarea></div>
                                    </div>
                                </div>
                                </div>
                                <div class="modal-footer">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Doctor Name:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_doctor errorss"></span>
                                            <select class="mb-3 form-select patientschedule" id="patient-doctorname" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"  name="doctor_name">
                                            <option value="">Doctor Name</option>
                                            </select></div>
                                    </div>
...
Dropzone.options.myDropzone = {
    ...
    dictDefaultMessage: "Drag an image here or click to select one image"
        ...
        $("#usermanages").css("color", "#6a6ee4");
        $("#usersub").css("color", "#6a6ee4");
