                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="invoice_upload" name="invoice_upload[]" multiple accept="image/*,application/pdf" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;">
...
<script src="{{ asset('/assets/js/purchase/maker.js') }}"></script>
