              ...
              <div class="container" style="margin-top: -51px;">
                    ...
                    <!-- Row 1 -->
                     <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold"> MocDoc </h3>
                ...
                <div class="row g-4">
                    <!-- Row 1 -->
                     <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold"> Actual </h3>

                        </div>
                    </div>
                     <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold" id="actuall_cash">0</h3>
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Actual Cash</p>
                        </div>
                    </div>
                    <!-- Row 2 -->
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold" id="actuall_card">0</h3>
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Actual Card</p>
                        </div>
                    </div>
                    <!-- Row 3 -->
                    ...
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold" id="actuall_neft">0</h3>
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Actual Neft</p>
                        </div>
                    </div>
                    <!-- Row 6 -->
                    ...
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold" id="actuall_upi">0</h3>
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Actual UPI</p>
                        </div>
                    </div>
                    <!-- Row 8 -->
                    <div class="col-md-1 col-sm-3">
                        <div class="stat-card text-center  p-2 shadow-sm" style="border: 1px solid #c3bfc3; border-radius: 8px;">
                            <h3 class="fs-5 fw-bold" id="actuall_amount">0</h3>
                            <p class="text-muted mb-0" style="font-weight: 600; font-size: 10px;">Actual Amount</p>
                        </div>
                    </div>
...
<!-- income related script start -->
 ...
 <script src="{{ asset('/assets/income/Income_reconciliation_overview.js') }}"></script>
...
<script type="text/javascript">
    ...
    const downloadIncomeUrl = "{{ route('income.downloadIncomeRconciliation') }}";
