												...
												<div class="vehicle-dropdown-options">
													@if($vehicle_no)
														@foreach ($vehicle_no as $vehicle)
															<div data-value="{{ $vehicle->id }}"> {{ $vehicle->vehicle_no . ' - ' . $vehicle->make }}</div>
															@endforeach
													@endif
												</div>
											</div>
                        ...
                        <div id="error-message"></div>
							...
							@csrf                             
                                <div class="row">                                    
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Vehicle Type:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_department errorss"></span>
											<div class="dept-dropdown">
												<input type="text" class="searchDept" placeholder="Select Vehicle Type" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;font-size:12px" required name="vehicle_type" autocomplete="off">
                        ...
                        <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-12">
												...
												@if($type)
														@foreach ($type as $vt)
															<option value="{{ $vt->id }}">{{ $vt->type}}</option>
															@endforeach
													@endif
												</select> 												
											</div>
