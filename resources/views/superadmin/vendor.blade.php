                ...
                <div class="page-block">
                    <div class="row ">
                        ...
                        <div class="col-md-3 col-sm-3 add-doctors">
                            <a href="#" class="btn btn-primary d-inline-flex align-items-center gap-2 editbtn" data-bs-toggle="modal" data-bs-target="#customer-edit_add-modal" style="height: 34px;width: 133px;font-size: 12px;background-color: #6a6ee4;--bs-btn-border-color: #6a6ee4;"><i class="ti ti-plus f-18"></i>Vendor</a>
                        </div>
                    </div>
                </div>
            </div><br><br>
                                ...
                                <table class="tbl">
                                    <thead class="thd">
                                        <tr class="trview">
                                            ...
                                            <th class="thview">Company Name</th>
                                            <th class="thview">Email</th>
                                            <th class="thview">Mobile Number</th>
                                            <th class="thview">Address</th>
                                            <th class="thview">Gst/Tax ID</th>
                                            <th class="thview">Pan Number</th>
                                            <th class="thview">Account Number</th>
                                            <th class="thview">IFSC Code</th>
                                            <th class="thview">Name of Bussiness</th>
                                            <th class="thview">Contact Name</th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Name</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;"  class="error_vendor_name errorss"></span>
												...
												<input type="text" class="form-control" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;font-size:12px"  required name="vendor_name" id="vendor_name" placeholder="Enter Name">
											
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Company Name</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_company_name errorss"></span>
                                            <input type="text" class="form-control" id="company_name" name="company_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Company Name"  >
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Email</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_email errorss"></span>
                                            <input type="text" class="form-control" id="email" name="email" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Enter Your Email"  >
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Mobile Number</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_phone_number errorss"></span>
                                            <input type="text" class="form-control" id="phone_number" name="phone_number" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Enter Your Mobile Number"  >
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                     <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Address</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_address errorss"></span>
                                            ...
                                            <textarea class="form-control" row='5' name="address" id="address"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">GST/Tax ID</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_gst_tax_id errorss"></span>
                                            <input type="text" class="form-control" id="gst_tax_id" name="gst_tax_id" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Gst/Tax" >
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">PAN Number:</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_pan_number errorss"></span>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Account Number:</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_account_number errorss"></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">IFSC Code:</label>&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_ifsc_code errorss"></span>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Name Of Business</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_business_name errorss"></span>
                                            <input type="text" class="form-control" id="business_name" name="business_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Business">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Contact Person Name</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_contact_name errorss"></span>
                                            <input type="text" class="form-control" id="contact_name" name="contact_name" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;" placeholder="Contact Person Name">
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="col-sm-3">
                                     ...
                                     <div class="col-sm-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="bank_upload" name="bank_upload[]" multiple accept="image/*,application/pdf" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="pan_upload" name="pan_upload[]" multiple accept="image/*,application/pdf" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;">
                                            <input type="hidden" name="existing_pan_file" id="existing_pan_file">
                                        </div>
                                    </div>
                                     <div class="col-sm-4">
                                        <div class="mb-3">
                                            <label class="form-label required" style="font-size: 12px;font-weight: 600;">Upload Company Registration</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;" class="error_upload_company_register errorss"></span>
                                            <input type="file" class="form-control" id="upload_company_register" name="upload_company_register[]" multiple accept="image/*,application/pdf" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;">
                                            <input type="hidden" name="existing_upload_company_register" id="existing_upload_company_register">
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="row">
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="po_upload" name="po_upload[]" multiple accept="image/*,application/pdf" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="po_signed_upload" name="po_signed_upload[]" multiple accept="image/*,application/pdf" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="po_delivery_upload" name="po_delivery_upload[]" multiple accept="image/*,application/pdf" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;">
