...
<body @@bodySetup>
    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="row">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i
                                        class="ti ti-plus f-18"></i>New Category</button>
                            </div>
                        </div>
                        <div>&nbsp;</div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" id="formsubmit">
                                                <div class="mb-3">
                                                    <label for="recipient-name" class="col-form-label pt-0">Category
                                                        Name</label>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-primary add_category">Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <form method="post" id="formsubmit">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button type="button"
                                                        class="btn btn-primary update_category">Submit</button>
                                                </div>
                ...
                <button id="categoryCreate" class="btn btn-light-warning" style="display:none;">Try me!</button>
                <button id="categoryUpdate" class="btn btn-light-primary" style="display:none;">Try me!</button>
    ...
    $(document).ready(function() {
      $.ajaxSetup({
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        $('#category_name1').val(response.priority.depart_name);
                        if (response.priority.dept_status == 1) {
                            $('#flexCheckDefault').prop('checked', 'true');
                        } else if (response.priority.dept_status == 0) {
        ...
        $(document).on('click', '.update_category', function(e) {
            ...
            var data = {
                'depart_name': $('#category_name1').val(),
                'dept_status': status1
            }
        ...
        { 
            $('#ajax-crud-datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('superadmin.categoryList') }}",
                    type: "POST",
                    data: function (data1) {
  ...
  document.getElementById('categoryCreate').addEventListener('click', () => {
  ...
  document.getElementById('categoryUpdate').addEventListener('click', () => {
    window.dispatchEvent(new CustomEvent('swal:toast', {
        detail: {
          title:'Info!',
