...
<style>
    ...
    .active-document-btn {
        background-color: #3A6AD4 !important; /* green highlight */
        color: white !important;
        /* border-color: #3A6AD4 !important; */
    }
...
<body style="overflow-x: hidden;">
                    ...
                    <div class="row ">
                        <div class="col-md-8 col-sm-8">
                            <input type="text" id="icon-search" class="form-control mb-4"
                                style="height: 35px;font-size: 11px;" placeholder="Search">
                        </div>
                        <div class="col-md-2 col-sm-2" id="document_btn">
                            <a href="#" class="btn btn-primary d-inline-flex align-items-center gap-2 editbtn"
                                data-bs-toggle="modal" data-bs-target="#customer-edit_add-modal"
                                style="height: 34px;width: 140px;font-size: 12px;background-color: #6a6ee4;--bs-btn-border-color: #6a6ee4;"><i
                                    class="ti ti-plus f-18"></i> Add Vehicles</a>
                        </div>
                        <div class="col-md-2 col-sm-2" id="documentbtn">
                            <!-- <a href="#" class="btn btn-primary d-inline-flex align-items-center gap-2 doceditbtn"
                                data-bs-toggle="modal" data-bs-target="#customer-edit_add-modal"
                                style="height: 34px;width: 133px;font-size: 12px;background-color: #6a6ee4;       --bs-btn-border-color:#6a6ee4;"><i
                                    class="ti ti-plus f-18"></i> Add Document
                            </a> -->
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="analytics-tab-1" data-bs-toggle="tab"
                                    ...
                                    aria-controls="analytics-tab-1-pane" aria-selected="true">Vehicle Details</button>
                            </li>
                            <!-- <li class="nav-item" role="presentation">
                                <button class="nav-link" id="analytics-tab-2" data-bs-toggle="tab"
                                    data-bs-target="#analytics-tab-2-pane" type="button" role="tab"
                                    aria-controls="analytics-tab-2-pane" aria-selected="false">Vehicle
                                    Documents</button>
                            </li> -->
                        </ul>
                    </div>
                ...
                <div class="tab-pane fade show active" id="analytics-tab-1-pane" role="tabpanel"
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-md-2">
                                <div class="card">
                                    <div id="reportrange" style="background: #fff; cursor: pointer; padding: 5px 5px 5px 5px; border: 1px solid #ccc; width: 100%;font-size: 10px;">
                        ...
                        @php $zones = App\Models\TblZonesModel::select('name','id')->get(); @endphp
                        <div class="col-xl-2 col-md-2" >
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput single_search vehiclevalues_search"
                                        name="tblzones.id" id="zone_views" placeholder="Select Zone"
                                        autocomplete="off">
                                        <input type="hidden" id="veh_zone_id">
                                    <div class="dropdown-options single_search selectzone_vehicle vehicle_marketers ">
                                        @if ($zones)
                        ...
                        @php $location = App\Models\TblLocationModel::select('tbl_locations.name','tbl_locations.zone_id')->get(); @endphp
                        <div class="col-xl-2 col-md-2" >
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput single_search vehiclevalues_search"
                                        name="tbl_locations.name" id="branch_views" placeholder="Select Branch"
                                        autocomplete="off">
                                    <div class="dropdown-options single_search vehicle_marketers " id="getbranch">
                                        @if ($location)
                        ...
                        @php $reg_no = App\Models\vehicleDetails::select('vehicle_details.registration_number','make')->get(); @endphp
                        <div class="col-xl-2 col-md-2" >
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput single_search vehiclevalues_search"
                                        name="registration_number" id="reg_number"
                                        placeholder="Select Reg No" autocomplete="off">
                                    <div class="dropdown-options single_search vehicle_marketers ">
                                        @if ($reg_no)
                                            @foreach ($reg_no as $reg)
                                                <div data-value="{{ $reg->registration_number }}">{{ $reg->registration_number . ' - ' . $reg->make }}</div>
                                            @endforeach
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-2 col-md-2" >
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput single_search vehiclevalues_search"
                                        name="fuel_type" id="fuel_type_filter"
                                        placeholder="Select Fuel Type" autocomplete="off">
                                    <div class="dropdown-options single_search vehicle_marketers ">
                                                <div data-value="1">Petrol</div>
                                                <div data-value="2">Diesel</div>
                                                <div data-value="3">Electronic Vehicle</div>
                                                <div data-value="4">CNG</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <span style="cursor: pointer;" id="zone_search"
                                class="badge bg-success value_views_mainsearch"></span>

                    <span style="cursor: pointer;" id="branch_search"
                        class="badge bg-success value_views_mainsearch"></span>

                    <span style="cursor: pointer;" id="register_number_search"
                            class="badge bg-success value_views_mainsearch"></span>
                                ...
                                <table class="tbl">
                                    <thead class="thd">
                                        <tr class="trview">
                                            ...
                                            <th class="thview">Cluster Name</th>
                                            <th class="thview">Manufacture Year</th>
                                            <th class="thview">Vehicle ID</th>
                                            <th class="thview">Branch</th>
                                            <th class="thview">Vehicle Name</th>
                                            <th class="thview">Vehicle Number</th>
                                            ...
                                            <th class="thview">Insurance Company Name</th>
                                            <th class="thview">Insurance Expire Date</th>
                                            <th class="thview">Add New Insurance for Existing Vehicle </th>
                                            ...
                                            <th class="thview">Vehicle Documents</th>
                                            <th class="thview">Vehicle Activities</th>
                                            <!-- <th class="thview">Closing Km</th>
                                            <th class="thview">Total Km Driven/Day</th>
                                            <th class="thview">Total Km Driven /Month</th>
                                            <th class="thview">Daily Photos </th>
                                            <th class="thview">Day Activity Report</th>
                                            <th class="thview">Passenger Travelled</th> -->
                                            <th class="thview">Edit Vehicle</th>
                                            <!-- <th class="thview">Update Document</th> -->
                                        </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            <td data-column-index="7">
                                                <img src="../assets/images/loader1.gif"
                                                    style="width: 50%;margin-left: 200%;" alt="Icon"
                                                    class="icon">
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #080fd399;height: 0px;">
                                    <h5 class="modal-title" id="exampleModalLabel"
                                        style="color: #ffffff;font-size: 12px;">Document Upload<span
                                            id="docu_id"></span></h5>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <input type="hidden" class="id" name="id" id="id_document"
                                            ...
                                            value="">
                                        <input type="hidden" class="expire_dates" name="expire_dates"
                                            id="expire_dates"
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                            value="">
                                        <input type="hidden" class="model" name="model" id="model"
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                            value="">
                                        <input type="hidden" class="update_documents_all"
                                            name="update_documents_all" id="update_documents_all"
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                            value="">
                                            <input type="hidden" class="vehicle_id"
                                        ...
                                        <div class="col-sm-3" id="vehicle_document_type">
                                            <div class="mb-3">
                                                <label class="form-label required"
                                                    ...
                                                    Type:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_priority errorss"></span>
                                                <select class="mb-3 form-select" id="document_type"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                        ...
                                        <div class="col-sm-6">
                                            <label class="form-label required"
                                                style="font-size: 12px;font-weight: 600;">Update Document [ Max 5 ]( Only PDF Files are Allowed )</label><span
                                                    style="font-size:10px; color:red;"
                                                    class="error_images errorss"></span>
                                            <div class="fallback"> &nbsp;&nbsp;
                                                <input name="files[]" id="pdf_update" type="file"
                                                    accept="application/pdf"
                                                    style="height: 28px;border: ridge; background-color: #ffffff; border-color: #ffffff;" multiple  required />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #6a6ee4;height: 0px;">
                                    <h5 class="modal-title" id="exampleModalLabel1" style="color: #ffffff;font-size: 12px;"> Add New Insurance Details for Existing Vehicle</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        style="background-color: #ffffff;" aria-label="Close"></button>
                                </div>
                                <ul id="save_msgList"></ul>
                                <div id="error-message"></div>
                                <div class="modal-body">
                                    <form method="post" action="{{route('superadmin.add_insurance_existing')}}" name="demoform"  id="demoform" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label required"
                                                        style="font-size: 12px;font-weight: 600;">OD Insurance Policy </label>&nbsp;&nbsp;
                                                    <input type="text" class="form-control" id=""
                                                        name="policy_details"
                                                        style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label required"
                                                        style="font-size: 12px;font-weight: 600;">TP Insurance Company name </label>&nbsp;&nbsp;
                                                    <input type="text" class="form-control" id=""
                                                        name="thirdparty_company_name"
                                                        style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                        placeholder="Enter Insurance Company name "required >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label required"
                                                        style="font-size: 12px;font-weight: 600;">TP Insurance Policy </label>&nbsp;&nbsp;
                                                    <input type="text" class="form-control" id=""
                                                        name="thirdparty_policy_details"
                                                        style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                        placeholder="Enter Insurance Policy"required >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label required"
                                                        ...
                                                        Insurance Pdf : [ Max 5 ] <br>( Only PDF Files are Allowed )
                                                    </label>
                                                    &nbsp;&nbsp;
                                                     <input type="file" class="form-control" id="image_uploads_add_ins"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label class="form-label required"
                                                        style="font-size: 12px;font-weight: 600;">Insurance Payment </label>&nbsp;&nbsp;
                                                    <input type="text" class="form-control" id=""
                                                        name="payment"
                                                        style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                        placeholder="Enter Insurance Policy" required>
                                        ...
                                        <div class="row">
                                            <div class="modal-footer">
                                                <button type="button" style="height: 34px;width: 133px;font-size: 12px;"
                                                    id="close-button" class="btn btn-outline-danger"
                                                    data-bs-dismiss="modal">Close</button>
                                                <button type="submit" id="submit-ticket-datas"
                                                    style="height: 34px;width: 133px;font-size: 12px;"
                                                    class="btn btn-outline-primary">Submit</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <div class="branch-dropdown">
                                                    <input type="text" class="searchBranch"
                                                        placeholder="Select Branch" id="branch_id"
                                                        style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;font-size:12px"
                                                         name="branch" autocomplete="off" read only >
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <label class="form-label required" style="font-size: 12px; font-weight: 600;">Branch:</label>
                                                <span style="font-size:10px; color:red;" class="error_location errorss"></span>

                                                <div class="branch-dropdown">
                                                    <!-- Read-only field displaying branch name -->
                                                    <input type="text" class="searchBranch"
                                                        placeholder="Select Branch" id="branch_id"
                                                        style="height: 36px; border-radius: 10px; border: solid 1px #d3d3d3; background-color: #dbd4d4; color: #505050 !important; width: 100%; padding-left: 6px; font-size:12px ;"
                                                        name="branch" autocomplete="off" readonly >
                                                </div>
                                                <br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Vehicle
                                                    Type:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_location errorss"></span>
                                                <div class="type-dropdown">
                                                    <input type="text" class="searchType"
                                                        ...
                                                        style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;font-size:12px"
                                                         name="vehicle_type" autocomplete="off">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Model:</label>&nbsp;&nbsp;<span
                                                    style="font-size:10px; color:red;"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Year of
                                                    Manufacture:</label>&nbsp;&nbsp;<span
                                                    style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                                <input type="text" class="form-control" id="yr_of_manufacture"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Registration
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Engine
                                                    Number:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Chassis
                                                    Number:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Fuel Type:
                                                </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_description errorss"></span>
                                                <select class="mb-3 form-select" id="fuel_type"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                     name="fuel_type">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Cluster Name</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                                <input type="text" class="form-control" id="cluster_name"
                                                    name="cluster_name"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Cluster Name" ><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Vehicle Number</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                                <input type="text" class="form-control" id="vehicle_number"
                                                    name="vehicle_number"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Vehicle Number" ><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="text" class="form-control" id="insurance_company_name"
                                                    name="company_name"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Company name " ><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="text" class="form-control" id="insurance_policy"
                                                    name="policy_details"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Policy" ><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">TP Insurance Company name </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                                <input type="text" class="form-control" id="thirdparty_insurance_company_name"
                                                    name="thirdparty_company_name"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Company name " ><br>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">TP Insurance Policy </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                                <input type="text" class="form-control" id="thirdparty_insurance_policy"
                                                    name="thirdparty_policy_details"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Policy" ><br>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Insurance Payment </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Late Service Date </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_subject errorss"></span>
                                                <input type="date" class="form-control" id="last_service_date"
                                                    name="last_service"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Last Serivce Date " ><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                ...
                                <div class="card-footer sticky-bottom bg-white">
                                    <div class="d-flex justify-content-between">
                                        <a href="#" style="height: 34px;width: 133px; font-size: 12px;"
                                            data-bs-dismiss="offcanvas" class="btn btn-outline-danger w-50 me-2">Clear All</a>
                                        <button style="height: 34px;width: 133px; font-size: 12px;"
                                            id="vehicle_update" data-bs-dismiss="offcanvas"
                                            class="btn btn-outline-primary w-50">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div class="card-body pc-component btn-page">
        <div class="modal fade" id="exampleModal3" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #6a6ee4;height: 0px;">
                        <h5 class="modal-title" id="exampleModalLabel1" style="color: #ffffff;font-size: 12px;"> Add
                            Insurance Details</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            style="background-color: #ffffff;" aria-label="Close"></button>
                    </div>
                    <ul id="save_msgList"></ul>
                        ...
                        {{-- <div class="col-sm-7">
                            <div class="mb-7">
                                <div class="d-flex justify-content-center p-2">
                                    <img src="../assets/images/policy.png" id="vehicle-insurance-main"
                                    class="main-image " height=400 style="width: 613px;">
                                </div>
                                <div id="vehicle-insurance-thumbnails" class="thumbnails d-flex gap-2 justify-content-center">
                        ...
                        <div class="col-sm-9 row">
                            <div class="col-sm-3"><br>
                                <div class="btn-group-vertical w-100"
                                    style="margin-left: 11px;  max-width: 100%;PADDING: 0px 11px 0px 0px;" id="insurance_document_view_buttons">
                            ...
                            <div class="col-sm-9">
                                <embed id="insurance_document_view" src="" width="100%" height="600px" />
                            </div>
                        </div>
                        <div class="col-sm-3"><br>
                            <div class="mb-4">
                                <div 
                                    ...
                                    {{-- <div class="views-ali" style="margin-left: 20px;margin-top: 20px;">
                                        ...
                                        <h4 class="alert-heading" style="font-size: 12px;">Insurance Expiry Date</h4>
                                        <p style="font-size: 12px;" class="doctor_names" id="insurance_date"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;margin-top: 15px;">Insurance
                                            Company</h4>
                                        <p style="font-size: 12px; margin-top: 0px;" id="ins_company"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Insurance Renewal Date</h4>
                                        <p style="font-size: 12px;" id="renewual_date"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Insurance Policy</h4>
                                        <p style="font-size: 12px;" class="empname_views_all" id="ins_poily"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Insurance Payment</h4>
                                        <p style="font-size: 12px;" id="ins_payment"></p>
    ...
    <!-- //////////////// -->
    <div class="card-body pc-component btn-page">
        <div class="modal fade" id="exampleModal4" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #6a6ee4;height: 0px;">
                        <h5 class="modal-title" id="exampleModalLabel1" style="color: #ffffff;font-size: 12px;"> Vehicle Activities</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            style="background-color: #ffffff;" aria-label="Close"></button>
                    </div>
                    <ul id="save_msgList"></ul>
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <!-- <div class="mb-7">
                                <img src="../public/doctor_images/1743226130_WhatsApp Image 2025-03-29 at 10.47.31 AM.jpeg"
                                    id="main">
                                <div id="thumbnails"><img
                                        src="../public/doctor_images/1743226130_WhatsApp Image 2025-03-29 at 10.47.31 AM.jpeg">
                                </div>
                            </div> -->
                            <div class="mb-7">
                                <img id="dailyphotos" src="" alt="Daily Photo" style="max-width: 100%;padding:50px;">
                                <!-- <img src="../assets/images/policy.png" id="vehicle-insurance-main"
                                    class="main-image"> -->
                                <!-- <div id="vehicle-insurance-thumbnails" class="thumbnails">
                                    <img src="../assets/images/policy.png">
                                    <img src="../assets/images/pdf.png">
                                </div> -->
                            </div>
                        ...
                        <div class="col-sm-4"><br>
                            ...
                            <div class="mb-4">
                                <div class="card" id="doctor_info_details"
                                    style="overflow-y: auto; max-height: 400px;scrollbar-width: thin; /* For Firefox */ ">
                                    <div class="views-ali" style="margin-left: 20px;margin-top: 20px;">
                                        <h4 class="alert-heading" style="font-size: 12px;">Opening Km</h4>
                                        <p style="font-size: 12px;" class="doctor_names" id="opening_km"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;margin-top: 15px;">Closing Km
                                        </h4>
                                        <p style="font-size: 12px; margin-top: 0px;" id="closing_km"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Total km Driven / day</h4>
                                        <p style="font-size: 12px;" id="drivenperday"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Total km Driven / Month
                                        </h4>
                                        <p style="font-size: 12px;" class="empname_views_all" id="drivenpermonth">
                                        </p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Daily Photos</h4>
                                        <p style="font-size: 12px;" id="dailyphotos"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Passenger Travelled</h4>
                                        <p style="font-size: 12px;" id="passenger_travel"></p>
                                        <h4 class="alert-heading" style="font-size: 12px;">Daily Activity Report</h4>
                                        <p style="font-size: 12px;" id="activity_report"></p>
                                    </div> <br>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #6a6ee4;height: 0px;">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            style="background-color: #ffffff;" id="xBtn" aria-label="Close"></button>
                    </div>
                    <ul id="save_msgList"></ul>
                    <div id="error-message"></div>
                    <div class="modal-body">
                        <form method="post" action="{{ route('superadmin.vehicleadded') }}" name="demoform"
                            id="demoform" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            style="font-size: 12px;font-weight: 600;">Branch:</label>&nbsp;&nbsp;<span
                                            style="font-size:10px; color:red;" class="error_location errorss"></span>
                                        <div class="loct-dropdown">
                                            <input type="text" class="searchLocation" placeholder="Select Branch"
                                                style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;font-size:12px"
                                                required name="branch" autocomplete="off">
                                            <div class="loct-dropdown-options">
                                                @if ($locations)
                                                    @foreach ($locations as $location)
                                                        <div data-value="{{ $location->id }}">{{ $location->name }}
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            style="font-size: 12px;font-weight: 600;">Vehicle
                                            Type:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                            class="error_department errorss"></span>
                                        <div class="dept-dropdown">
                                            <input type="text" class="searchDept"
                                                placeholder="Select Vehicle Type"
                                                style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;font-size:12px"
                                                required name="vehicle_type" autocomplete="off">
                                            <div class="dept-dropdown-options">
                                                @if ($type)
                                                    @foreach ($type as $vt)
                                                        <div data-value="{{ $vt->id }}">{{ $vt->type }}
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            style="font-size: 12px;font-weight: 600;">Model:</label>&nbsp;&nbsp;<span
                                            style="font-size:10px; color:red;" class="error_subject errorss"></span>
                                        <input type="text" class="form-control" id="vehicle_model" name="make"
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            style="font-size: 12px;font-weight: 600;">Year of
                                            Manufacture:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                            class="error_subject errorss"></span>
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="registration_number"
                                            ...
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                            placeholder="Enter Registered Owner" required>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="registration_number"
                                            name="rto_location"
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                            placeholder="Enter RTO" required>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                ...
                                <!-- <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            style="font-size: 12px;font-weight: 600;">Insurance Pdf : [ Min 2 - Max 5 ] <br> ( Only PDF Files are Allowed ) </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                            class="error_subject errorss"></span>
                                        <input type="file" class="form-control " id="image_uploads_add"
                                            name="files[]" accept="application/pdf"
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                            multiple="">
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            ...
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                             name="vehicle_incharge">
                                             @php $driver = App\Models\usermanagementdetails::where('category','Driver')->get(); @endphp
                                            <option value="">Select Incharge Driver</option>
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            ...
                                            style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                             name="vehicle_incharge_admin">
                                             @php $driveradmin = App\Models\usermanagementdetails::where('category','Driver Admin')->get(); @endphp
                                            <option value="">Select Incharge Admin</option>
                                            @foreach ($driveradmin as $adminname)
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #080fd399;height: 0px;">
                    <h5 class="modal-title" id="exampleModalLabel" style="color: #ffffff;font-size: 12px;">Vehicle Document</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        style="background-color: #ffffff;" aria-label="Close"></button>
                </div>
                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required"
                                                ...
                                                Type:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                class="error_location errorss"></span>
                                            <select class="mb-3 form-select morefittersclr" id="vehicle_type"
                                                style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                required name="vehicle_type.type">
                                                <option value="">Select Vehicle Type</option>
                                                @if ($type)
                                                    @foreach ($type as $vt)
                                                        <option value="{{ $vt->id }}">{{ $vt->type }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12"><br>
                                            <label class="form-label required"
                                                ...
                                                class="error_description errorss"></span>
                                            <select class="mb-3 form-select morefittersclr" id="vfuel_type"
                                                style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                required name="vehicle_details.fuel_type">
                                                <option value="">Select Fuel Type</option>
                                                <option value="1">Petrol</option>
                                                <option value="2">Diesel</option>
                                                <option value="3">Electronic Vehicle</option>
                            ...
                            <div class="card-footer sticky-bottom bg-white">
                                <div class="d-flex justify-content-between">
                                    <a href="#" style="height: 34px;width: 133px; font-size: 12px;"
                                        ...
                                        All</a>
                                    <a href="#" style="height: 34px;width: 133px; font-size: 12px;"
                                        id="vehicle_search" data-bs-dismiss="offcanvas"
                ...
                <div class="ecom-filter">
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between sticky-top bg-white">
                            <h5>Filter</h5>
                            <a href="#" class="avtar avtar-s btn-link-danger btn-pc-default clsrmv"
                                data-bs-dismiss="offcanvas" data-bs-target="#offcanvas_my_filter">
                                <i class="ti ti-x f-20"></i>
                            </a>
                        </div>
                        <!-- Scrollable Block -->
                        <div class="scroll-block position-relative">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12">
                                            <label class="form-label required"
                                                ...
                                                Type:</label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                class="error_location errorss"></span>
                                            <select class="mb-3 form-select myfittersclr" id="veh_type"
                                                style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                required name="vehicle_type.type">
                                                <option value="">Select Vehicle Type</option>
                                                @if ($type)
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12"><br>
                                            <label class="form-label required"
                                                ...
                                                class="error_description errorss"></span>
                                            <select class="mb-3 form-select myfittersclr" id="fuel_typ"
                                                style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                required name="vehicle_details.fuel_type">
                                                <option value="">Select Fuel Type</option>
                                                <option value="1">Petrol</option>
                            ...
                            <div class="card-footer sticky-bottom bg-white">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="#" style="height: 34px;width: 133px; font-size: 12px;"
                                        id="my_vehicle_search" data-bs-dismiss="offcanvas"
                                        class="btn btn-outline-primary w-50">Submit</a>
                                </div>
                            </div>
                        </div>
    ...
    <script src="{{ asset('/assets/vehicle/vehicle-details.js') }}"></script>
    <script>
        window.onload = function() {
            ...
            // Properly embedding Blade inside a script
    ...
    <script>
        document.getElementById('image_uploads').addEventListener('change', function (e) {
            const files = Array.from(this.files);
            const validFiles = [];
            const errorSpan = document.querySelector('.error_subject');
            ...
            } else if (validFiles.length < 1 || validFiles.length > 5) {
                errorSpan.textContent = "Please select minimum 2 and maximum 5 PDF files.";
                this.value = '';
            } else {
    ...
    <script>
        document.getElementById('image_uploads_add').addEventListener('change', function (e) {
            const files = Array.from(this.files);
            const validFiles = [];
            const errorSpan = document.querySelector('.error_subject');
        ...
        <script>
            document.getElementById('image_uploads_add_ins').addEventListener('change', function () {
                const files = this.files;
                const errorSpan = document.querySelector('.error_subject');

                if (files.length < 1) {
                    errorSpan.textContent = "Please select at least 1 PDF file.";
                    this.value = ''; // Clear selection
                } else if (files.length > 5) {
                    errorSpan.textContent = "You can upload a maximum of 5 PDF files.";
                    this.value = ''; // Clear selection
                } else {
                    let allPDF = Array.from(files).every(file => file.type === 'application/pdf');
                    if (!allPDF) {
                        errorSpan.textContent = "Only PDF files are allowed.";
                        this.value = ''; // Clear selection
                    } else {
    ...
    <script type="text/javascript">
        ...
        const vehicledocumentupdate = "{{ route('superadmin.vehicledocumentupdate') }}";
        ...
        const vehicleEditUrl = "{{ route('superadmin.vehicledocumentedit') }}";
        const fetchUrlmorefittervechicle = "{{ route('superadmin.fetchUrlmorefittervechicle') }}";
        const vehicleInsuranceDocumentUrl = "{{ route('superadmin.vehicleInsuranceDocument') }}";
        const vehicleDocumentViewUrl = "{{ route('superadmin.vehicledocumentview') }}";
    ...
    <script>
         $(document).ready(function () {
            ...
            $('#branch_views').on('focus', function () {
                const selectedType = Number($('#veh_zone_id').val()); // use hidden ID
                ...
                if (selectedType) {
                    ...
                    $('#getbranch > div').show().removeClass('selected');
                }

                $('#getbranch').show();
            });
            $('#getbranch > div').off('click').on('click', function () {
                    const name = $(this).data('value');
                    $('#branch_views').val(name);
        ...
        $(document).ready(function() {
            $(document).on("input", ".searchInput", function () {
				...
				$(this).siblings(".dropdown-options").find("div").each(function () {
					...
					const shouldShow = optionText.includes(searchText) && !currentValues.includes(fullText);
    ...
    <script>
            ...
            $(document).on("click", ".dropdown-options div", function (e) {
                const selectedValue = $(e.target).text().trim();
                const inputField = $(e.target).closest(".dropdown").find(".searchInput");
                const currentValues = inputField.val().split(",").map(v => v.trim());

                if (inputField.hasClass("single_search")) {
                    // SINGLE selection: Replace previous value
                    inputField.val(selectedValue);
                    inputField.siblings(".dropdown-options").find("div").each(function (index, element) {
            ...
            // When any input inside .dropdown is focused
