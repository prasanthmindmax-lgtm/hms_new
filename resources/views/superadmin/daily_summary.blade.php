...
<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="loct-dropdown">
                                     <input type="text" class="searchLocation dailyvalues_search" name="tbl_branch.zone" id="zone_views" placeholder="Select Zone" autocomplete="off">
                        ...
                        <div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="loct-dropdown">
                                    <input type="text" class="searchLocation dailyvalues_search" name="tbl_branch.name" id="branch_views" placeholder="Select Branch" autocomplete="off">
                                    <div class="loct-dropdown-options options_branch  branchviewsall" style="display: none;">
                                     
									  
											<!--<div data-value="" class="">PALAKKAD</div>
											<div data-value="">CALICUT</div>
											<div data-value="" class="">ERODE</div>
											<div data-value="">SALEM</div>
											<div data-value="">TIRUPPUR</div>
											<div data-value="">TIRUPPUR IP</div>
											<div data-value="">KUMALAN KUTTAI - ERODE</div>
											<div data-value="">Coimbatore</div>
											<div data-value="">HOSUR</div>
											<div data-value="">Sholinganallur</div>
											<div data-value="">Urapakkam</div>
											<div data-value="">Madipakkam</div>
											<div data-value="">Agraharam - SALEM</div>
											<div data-value="">Kanchipuram</div>
											<div data-value="">SUNDARAPURAM</div>
											<div data-value="">TRICHY</div>
											<div data-value="">Thiruvallur</div>
											<div data-value="">Pollachi</div>
											<div data-value="">Electronic City</div>
											<div data-value="">Konappana - Electronic City</div>
											<div data-value="">Tambaram</div>
											<div data-value="">Thanjavur</div>
											<div data-value="">Konanakunte</div>
											<div data-value="">HARUR</div>
											<div data-value="">COIMBATORE</div>
											<div data-value="">Varadhambalayam</div>
											<div data-value="">THUDIYALUR</div>
											<div data-value="">MADURAI</div>
											<div data-value="">HEBBAL</div>
											<div data-value="">KALLAKURICHI</div>
											<div data-value="">VELLORE</div>
											<div data-value="">TIRUPATHI</div>
											<div data-value="">Attur</div>
											<div data-value="">Namakkal</div>
											<div data-value="">Dasarahalli</div>
											<div data-value="">Chengalpattu</div>
											<div data-value="">Vadapalani</div>
											<div data-value="">Pennagaram</div>
											<div data-value="">Thirupattur</div>
											<div data-value="">Sivakasi</div>-->
...
<span class="search_daily" style="color: #e40505;font-size: 12px;font-weight: 600;">Search :</span>
<span style="cursor: pointer;" id="dbranch_search" class="badge bg-success value_views_mainsearch"></span>
<span style="cursor: pointer;" id="dzone_search" class="badge bg-success value_views_mainsearch"></span>
    ...
    <table class="tbl">
        <thead class="thd">
            <tr class="trview">
                ...
                <th class="thview">O/P Income</th>
                <th class="thview">I/P Income</th>
                <th class="thview">Pharmacy Income</th>
...
<script src="{{ asset('/assets/dailysummary/dailysummary-details.js') }}"></script>
