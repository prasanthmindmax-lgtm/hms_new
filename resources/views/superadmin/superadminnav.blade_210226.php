...
/* Scrollbar for .menuupdatesall */
.menuupdatesall {
    /* margin: 30px 0 0 0 !important; */
    margin: 6px 0 75px 0 !important;
    width: 240px !important;
    overflow-y: scroll !important;
}

/* Chrome, Edge, Safari */
.menuupdatesall::-webkit-scrollbar {
    width: 5px;
}

.menuupdatesall::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 10px;
}

.menuupdatesall::-webkit-scrollbar-thumb {
    background: #888;
    border-radius: 10px;
}

.menuupdatesall::-webkit-scrollbar-thumb:hover {
    background: #555;
}
