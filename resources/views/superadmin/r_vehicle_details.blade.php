...
"><i
                                    class="ti ti-plus f-18"></i> Add Vehicle</a>
                        </div>
                ...
                <div class="tab-pane fade show active" id="analytics-tab-1-pane" role="tabpanel"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2 col-md-2" >
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search vehiclevalues_search"
                                        name="tblzones.name" id="zone_views" placeholder="Select Zone"
                                        autocomplete="off">
                                    <div class="dropdown-options multi_search vehicle_marketers ">
                                        @if ($zones)
                        ...
                        <div class="col-xl-2 col-md-2" >
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search vehiclevalues_search"
                                        name="vehicle_details.registration_number" id="reg_number"
                        ...
                        <div class="col-xl-2 col-md-2" >
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search vehiclevalues_search"
                                        name="vehicle_details.fuel_type" id="fuel_type_filter"
...
"><i
                                        class="ti ti-filter f-18"></i>&nbsp; More Filter</a>
                            </div>&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <p style="
    margin-top: -9px;
" class="text-muted f-12 mb-0"><span
                            class="text-truncate w-100"><span id="counts">0</span> Rows </span>
                        <span class="search_view" style="color: #e40505;font-size: 12px;font-weight: 600;">Search
                            :</span>
                        ...
                        <span style="cursor: pointer;" id="insurance_company_search"
                            class="badge bg-success value_views_mainsearch"></span>
                        <span style="cursor: pointer;" id="insurance_expiry_date_search"
                            class="badge bg-success value_views_mainsearch"></span>
                ...
                <div class="tab-pane fade" id="analytics-tab-2-pane" role="tabpanel"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2 col-md-2" style="width:18.6%">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search veh_search"
                                        name="vehicle_details.registration_number" id="veh_reg_number"
                                        placeholder="Select Reg No" autocomplete="off">
                        ...
                        <div class="col-xl-2 col-md-2" style="width:18.6%">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search veh_search"
                                        name="tbl_locations.name" id="veh_branch_views" placeholder="Select Branch"
                                        autocomplete="off">
                        ...
                        <div class="col-xl-2 col-md-2" style="width:18.6%">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search veh_search"
                                        name="tblzones.name" id="veh_zone_views" placeholder="Select Zone"
                                        autocomplete="off">
...
"><i
    ...
    margin-top: -9px;
" class="text-muted f-12 mb-0"><span
                            class="text-truncate w-100"><span id="mycounts">0</span> Rows for <span
                        ...
                        <span class="my_search_view" style="color: #e40505;font-size: 12px;font-weight: 600;">Search
                            :</span>
                        <span style="cursor: pointer;" id="created_my_search"
                            class="badge bg-success value_views_mysearch"></span>
                        <span style="cursor: pointer;" id="mybranch_search"
                            class="badge bg-success value_views_mysearch"></span>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-sm-3" id="docu_vehicle_no">
                                            <div class="mb-3">
                                                <label class="form-label required"
                                                    style="font-size: 12px;font-weight: 600;">Vehicle No:
                                                </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                                    class="error_description errorss"></span>
                                                <div class="vehicle-dropdown">
                                                    <input type="text" id="locationInput" class="searchVehicle"
                                                        name="tbl_locations.name" placeholder="Select Vehicle No"
                                                        ...
                                                        required name="location" autocomplete="off">
                                                    <div class="vehicle-dropdown-options">
                                                        @if ($vehicle_no)
                                                            @foreach ($vehicle_no as $vehicle)
                                                                <div data-value="{{ $vehicle->id }}">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="fallback"> &nbsp;&nbsp;<span
                                                    style="font-size:10px; color:red;"
                                                    class="error_images errorss"></span>
                                                <input name="files[]" id="pdf_update" type="file"
                                                    accept="application/pdf"
                                                    style="height: 28px;border: ridge; background-color: #ffffff; border-color: #ffffff;" multiple />
                                            </div>
                                        </div>
                                    </div>
            ...
            <div id="ecom-filter" class="collapse collapse-horizontal show">
                <div class="ecom-filter">
                    <div class="card">
                        ...
                        <!-- Scrollable Block -->
                        <form method="post" action="{{ route('superadmin.vehicleupdate') }}" name="demoform"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="text" class="form-control" id="cluster_name"
                                                    name="cluster_name"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Cluster Name" required><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="text" class="form-control" id="vehicle_number"
                                                    name="vehicle_number"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Vehicle Number" required><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="text" class="form-control" id="insurance_company_name"
                                                    name="company_name"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Company name " required><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="date" class="form-control" id="insurance_expiry_data"
                                                    name="expiry_date"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Expiry Date" required><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="date" class="form-control" id="insurance_renewal_date"
                                                    name="renewal_date"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Renewal Date " required><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="text" class="form-control" id="insurance_policy"
                                                    name="policy_details"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Insurance Policy" required><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="date" class="form-control" id="last_service_date"
                                                    name="last_service"
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Last Serivce Date " required><br>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-12">
                                                ...
                                                <input type="date" class="form-control" id="last_tyre_changed_date"
                                                    ...
                                                    style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;"
                                                    placeholder="Enter Last Serivce Date " required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form method="post" action="{{ route('superadmin.vehicleadded') }}" name="demoform"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        <label class="form-label required"
                                            style="font-size: 12px;font-weight: 600;">Insurance Images : [ Min 2 - Max 5 ] </label>&nbsp;&nbsp;<span style="font-size:10px; color:red;"
                                            class="error_subject errorss"></span>
       ...
       /* $(document).on("focus", ".searchInput", function() {
		...
		$(document).on("focus", ".searchInput", function () {
			...
			inputField.siblings(".dropdown-options").find("div").each(function () {
				...
				const shouldShow = !currentValues.includes(optionText);

				$(this).toggle(shouldShow); // Hide selected
				$(this).removeClass("selected"); // Reset selection class
			});
