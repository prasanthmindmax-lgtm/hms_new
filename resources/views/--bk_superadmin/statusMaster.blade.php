...
<body @@bodySetup>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0)">Ticket Status Master</a></li>
                            </ul>
                        </div>
                        <!-- <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body border-bottom pb-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <h3 class="mb-0">Ticket Status Master</h3>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i
                                        class="ti ti-plus f-18"></i>New Status</button>
                            </div>
                        </div>
                        <div>&nbsp;</div>
                        <div class="col-sm-12">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" id="formsubmit" >
                              <div class="mb-3">
                                <label for="recipient-name" class="col-form-label pt-0">Status Name</label>
                                <input type="text" class="form-control" id="status_name" placeholder="Status Name" />
                              </div>
                              <div class="mb-3">
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary add_priority">Submit</button>
                              </div>
                            </form>
                          </div>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" id="formsubmit" >
                              <div class="mb-3">
                                <label for="recipient-name" class="col-form-label pt-0">Status Name</label>
                                <input type="text" class="form-control" id="status_name1" placeholder="Status Name" />
                              </div>
                              <div class="mb-3">
                                <label for="exampleColorInput" class="form-label">Color picker</label>
                                  <input
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary update_priority">Submit</button>
                              </div>
    ...
    <button id="statusCreate" class="btn btn-light-warning" style="display:none;">Try me!</button>
    <button id="statusUpdate" class="btn btn-light-primary" style="display:none;">Try me!</button>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.add_priority', function(e) {
            ...
            var data = {
                ...
                'status_color': $('#colorId').val(),
            }

            $.ajax({
                type: "POST",
                url: "/tasks/statusMaster",
                data: data,
                dataType: "json",
        ...
        $(document).on('click', '.editbtn', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "/tasks/edit-statusMaster/" + id,
                success: function(response) {
                    if (response.status == 404) {
                        ...
                        $('#status_name1').val(response.priority.status_name);
                        $('#colorId1').val(response.priority.status_color);
        ...
        $(document).on('click', '.update_priority', function(e) {
            ...
            var data = {
                'status_name': $('#status_name1').val(),
                'status_color': $('#colorId1').val(),
            }

            $.ajax({
                type: "PUT",
                url: "/tasks/update-statusMaster/" + id,
                data: data,
                dataType: "json",
                success: function(response) {
                    // console.log(response);
        ...
        $(document).on('click', '.delete_student', function(e) {
            ...
            $.ajax({
                type: "DELETE",
                url: "/tasks/delete-statusMaster/" + id,
                dataType: "json",
                success: function(response) {
                    // console.log(response);
                    if (response.status == 404) {
        ...
        function getAjaxRecords() {
            $('#ajax-crud-datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('superadmin.statusList') }}",
                    type: "POST",
                    data: function(data1) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "fnCreatedCell": function(nTd, sData, oData, iRow, iCol) {
                            $(nTd).html("<input type='color' value='" + oData.status_color +
                                "'>");
                        }
                    },
                    {
    ...
    document.getElementById('statusUpdate').addEventListener('click', () => {
        window.dispatchEvent(new CustomEvent('swal:toast', {
            detail: {
                title: 'Info!',
