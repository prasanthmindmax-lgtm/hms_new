                ...
                <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      aria-selected="true">Doecuments</button>
                  </li>
                </ul>
              </div>
</div>
    ...
    <div class="card">
        <div class="dropdown">
            ...
            <div class="dropdown-options options_patient">
                <div data-value="Rental Agreement">Rental Agreement</div>
                <div data-value="Rental PCB Agreement">Rental PCB Agreement</div>
                <div data-value="Fire NOC">Fire NOC</div>
                <div data-value="PCB NTT Application Form & Payment receipt">PCB NTT Application Form & Payment receipt</div>
                <div data-value="PCB NTT License">PCB NTT License</div>
                <div data-value="Retail schedule X License">Retail schedule X License</div>
                <div data-value="Retail Narcotic Certificate">Retail Narcotic Certificate</div>
                <div data-value="Wholesale Drug license">Wholesale Drug license</div>
                <div data-value="CEA Application Form & payment receipt">SCEA Application Form & payment receipt</div>
                <div data-value="CEA License">CEA License</div>
                <div data-value="PCB Application form & License">PCB Application form & License</div>
                <div data-value="ART Application form & License">ART Application form & License</div>
                <div data-value="ART Inspection PDF Book">ART Inspection PDF Book</div>
                <div data-value="ART Level 2 /1 License">ART Level 2 /1 License</div>
                <div data-value="ART Bank License">ART Bank License</div>
                <div data-value="ART Surrogacy License">ART Surrogacy License</div>
                <div data-value="Sanatory License">Sanatory License</div>
                <div data-value="Trade License">Trade License</div>
                <div data-value="MTP License">MTP License</div>
                <div data-value="Professional Tax certificate">Professional Tax certificate</div>
                <div data-value="Labour License">Labour License</div>
                <div data-value="Labour Inspector">Labour Inspector</div>
                <div data-value="Property Tax receipts">Property Tax receipts</div>
