                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs mb-3" id="matchTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="match-tab" data-bs-toggle="tab" data-bs-target="#match-content" type="button">
                                MATCH TRANSACTIONS
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="categorize-tab" data-bs-toggle="tab" data-bs-target="#categorize-content" type="button">
                                CATEGORIZE MANUALLY
                            </button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="matchTabContent">
                        ...
                        <div class="tab-pane fade show active" id="match-content">
                        ...
                        {{-- Categorize Manually Tab --}}
                        <div class="tab-pane fade" id="categorize-content">
                            <div class="text-center py-5">
                                <i class="bi bi-tag" style="font-size: 48px; color: #ccc;"></i>
                                <p class="text-muted mt-3">Manual categorization feature coming soon</p>
                            </div>
                        </div>
                    </div>
                </div>
