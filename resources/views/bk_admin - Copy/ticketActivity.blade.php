                      ...
                      @php $ticketImages = App\Models\ImageModel::where('ticket_id',  $ticketActivity->id)->get();    @endphp
                        ...
                        @foreach ($ticketImages as $ticketImage)
                          <div class="col-xl-2 col-lg-3 col-sm-4 col-xs-12">
                              ...
                              @else
                              <div class="vertical-scroll-block grow overflow-x-auto refresh1">
            ...
            <div class="modal-content">
              ...
              <ul id="save_msgList"></ul>
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.adminReplyActivity') }}" name="demoform" id="demoform"  enctype="multipart/form-data">
                    @csrf
