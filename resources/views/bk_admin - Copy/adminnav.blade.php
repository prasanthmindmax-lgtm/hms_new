    ...
    <div class="navbar-content">
      ...
      <ul class="pc-navbar">
       ...
       <!-- <li class="pc-item pc-caption">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="{{ route('admin.createticket') }}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-status-up"></use>
              </svg>
        ...
        <li class="pc-item pc-hasmenu">
          <a href="{{ route('admin.tickets')}}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
        ...
        <!-- <li class="pc-item pc-hasmenu">
          <a href="{{ route('admin.selfTickets')}}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-clipboard"></use>
              </svg>
            </span>
            <span class="pc-mtext">Self Tickets</span>
          </a> 
        </li> -->
