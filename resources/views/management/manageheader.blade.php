  ...
  <div class="header-wrapper"> 
    ...
    <ul class="list-unstyled">
       <!--  <li class="dropdown pc-h-item" id="countUpdate"><a class="pc-head-link dropdown-toggle arrow-none me-0"
            ...
            <span class="badge bg-success pc-h-badge" id="countUpdate">
                @php $notiCounts = App\Models\TicketModel::select('ticket_details.*')
                                ->where('ticket_details.is_read', 5)->get();    
                @endphp 
                {{ count($notiCounts) }}
            </span>
            </a>
          <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
            <div class="dropdown-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('management.approveTickets') }}" class="pc-link">Mark all read</a>
            </div>
            <div class="dropdown-body text-wrap header-notification-scroll position-relative"
                ...
                @if ($notiCounts)
                    ...
                    <div class="card mb-2">
                        <a href="{{ route('management.approveTickets') }}">
                            <div class="card-body">
                                <div class="d-flex">
        ...
        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
            ...
            <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                ...
                <div class="flex-shrink-0">
                    <img src="{{ asset('/assets/images/user/avatar-2.jpg') }} " alt="user-image" class="user-avtar wid-35" style="margin-left: 2em;"/>
                </div>
                <div class="flex-grow-1 ms-3">
                <div class="flex-grow-1 ms-3">
