...
<html lang="en">
  ...
  @include('management.superadminhead')
  <!-- [Head] end -->
  <!-- [Body] Start -->
...
ul li label {
  ...
  <body style="overflow-x: hidden;">
    ...
    <!-- [ Sidebar Menu ] start -->
    @include('management.superadminnav')
<!-- [ Sidebar Menu ] end -->
<!-- [ Header Topbar ] start -->
    @include('management.superadminheader')  
...
@php $user_name = App\Models\usermanagementdetails::select('users.user_fullname')
                                ->whereIn('users.role_id', [3,4,5])->get();    
                  @endphp 
<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                    ...
                    <div class="modal-content">
                        ...
                        <div id="error-message"></div>
                            ...
                            <div class="modal-body">
							 <form method="post" action="{{ route('management.ticketadded') }}" name="demoform" id="demoform"  enctype="multipart/form-data">
							@csrf
...
<script src="{{ asset('/assets/management/ticket-details.js') }}"></script>
...
<script type="text/javascript">
    ...
    const ticketfetchUrl = "{{ route('management.ticketfetch') }}";
    const allticketfetchUrl = "{{ route('management.allticketfetch') }}";
    const myticketfetchUrl = "{{ route('management.myticketfetch') }}";
	const ticketfillter = "{{ route('management.ticketfillter') }}";
	const allticketfillter = "{{ route('management.allticketfillter') }}";
	const myticketfillter = "{{ route('management.myticketfillter') }}";
	const ticketdatefillter = "{{ route('management.ticketdatefillter') }}";
	const allticketdatefillter = "{{ route('management.allticketdatefillter') }}";
	const myticketdatefillter = "{{ route('management.myticketdatefillter') }}";
	const fetchUrlticketfitterremove = "{{ route('management.fetchticketfitterremove') }}";
	const fetchAllticketfitterremove = "{{ route('management.fetchallfitterremove') }}";
	const fetchMyticketfitterremove = "{{ route('management.fetchmyticketfitterremove') }}";
	const fetchUrlmorefitter = "{{ route('management.fetchticketfitter') }}";
	const fetchMymorefitter = "{{ route('management.fetchmyticketfitter') }}";
	const fetchAllmorefitter = "{{ route('management.fetchallticketfitter') }}";
...
<script>
    ...
    <!-- [ Main Content ] end -->
     @include('management.superadminfooter')
  </body>
  <!-- [Body] end -->
</html>
