    ...
    <div class="navbar-content">
      ...
      <ul class="pc-navbar">        
        <li class="pc-item pc-hasmenu">
          <a href="{{ route('management.dashboard') }}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
		...
		<li class="pc-item pc-hasmenu">
          <a href="{{ route('management.ticket') }}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-status-up"></use>
              </svg>
        ...
        <li class="pc-item pc-hasmenu">
          <a href="{{ route('management.tickets')}}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-clipboard"></use>
              </svg>
            </span>
            <span class="pc-mtext">All Tickets</span>
          </a> 
        </li>

        <li class="pc-item pc-hasmenu">
          <a href="{{ route('management.approveTickets')}}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-clipboard"></use>
              </svg>
            </span>
            <span class="pc-mtext">Approve Tickets</span>
          </a> 
        </li>-->
