...
.loct-dropdown,.myloct-dropdown {
        position: relative;
        width: 100%;
        font-size: 10px;
    }

    .loct-dropdown input, .myloct-dropdown input{
        width: 100%;
        padding: 5px 10px;
        border: 1px solid #ccc;
        box-sizing: border-box;
    ...
    .loct-dropdown-options,.myloct-dropdown-options {
        position: absolute;
        top: 100%;
        left: 0;
        width: 100%;
    ...
    .loct-dropdown-options div,.myloct-dropdown-options div {
        padding: 10px;
        cursor: pointer;
    }

    .loct-dropdown-options div:hover,.myloct-dropdown-options div:hover {
        background-color: rgb(107 111 229);
        color: white;
    }

    /* Show dropdown when needed */
    .loct-dropdown.active .loct-dropdown-options,.myloct-dropdown.active .myloct-dropdown-options {
        display: block;
    }

    /* Highlight selected values */
.loct-dropdown-options div.selected,.myloct-dropdown-options div.selected {
    background-color: rgb(107 111 229) !important;
    color: white !important;
    font-weight: bold;
}
...
<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-options multi_search options_marketers marketernameall">
									 @if($user_name)
                        ...
                        <div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-options multi_search options_marketers brachviewsall">
                                       @if($location)
...
@php $zones = App\Models\TblZonesModel::select('name')->get(); @endphp 
                        <div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-options multi_search options_marketers zoneviewsall">
                                         @if($zones)
						...
						<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search marketervalues_search" name="department.depart_name" id="depart_search" placeholder="Select Dept" autocomplete="off">
                                    <div class="dropdown-options multi_search options_marketers depat_views">
                                        @if($categories)
...
<span style="cursor: pointer;" id="ddepart_search" class="badge bg-success value_views_mainsearch"></span>
        ...
        <table class="tbl">
            <thead class="thd">
                <tr class="trview">
                    ...
                    <th class="thview" style="width: 12%;">Status</th>
                </tr>
            </thead>
...
@php $locat = App\Models\TblLocationModel::select('tbl_locations.name')->get(); @endphp 
						...
						<div class="col-xl-2 col-md-2">
                            <div class="card">
                                <div class="dropdown">
                                    <input type="text" class="searchInput multi_search mymarketer_search" name="department.depart_name" id="mydeprt_search" placeholder="Select Dept" autocomplete="off">
                                    <div class="dropdown-options multi_search my_options_marketers dept_views">
                                        @if($categories)
												@foreach ($categories as $category)
													<div data-value="{{ $category->id }}">{{ $category->depart_name}}</div>
													@endforeach
...
<span style="cursor: pointer;" id="dept_search" class="badge bg-success value_views_mysearch"></span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-12"><br>
												...
												<div class="myloct-dropdown-options">
													@if($locations)
														@foreach ($locations as $locatio)
															<div data-value="{{ $locatio->id }}">{{ $locatio->name}}</div>
															@endforeach
													@endif
												</div>
											</div>
...
<div class="col-sm-12">
                ...
                <div
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel" style="color: #ffffff;font-size: 12px;">Add Ticket</h5>
                        ...
                        <div id="error-message"></div>
                            <div class="modal-body">
							 <form method="post" action="{{ route('admin.ticketadded') }}" name="demoform" id="demoform"  enctype="multipart/form-data">
							@csrf
                                    ...
                                    <div class="col-sm-3">
                                        <div class="mb-3">
											...
											<div class="dept-dropdown">
												<input type="text" class="searchDept" placeholder="Select Department" style="height: 36px;border-radius: 10px;border: solid 1px #d3d3d3;background-color: #fff;color: #505050 !important;width: 100%;padding-left: 6px;font-size:12px" required name="department">
            ...
            <div class="col-sm-12">
                ...
                <div
                    ...
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel" style="color: #ffffff;font-size: 12px;">Doctor Details : #<span id="doctor_ids"> 4</span></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" style="background-color: #ffffff;" aria-label="Close"></button>
                        </div>
                        <div class="row">
                                ...
                                <div class="mb-4"><br>
                                    ...
                                    <div class="card">
                                       ...
                                       <h4 class="alert-heading" style="font-size: 12px;">Address details</h4>
                                       <p style="font-size: 12px;" id="doctor_names">Name : Dr.Aravindivf</p>
                                       <p style="font-size: 12px; margin-top: -12px;" id="docaddress">50/287, Bypass Rd, Meyyanur, Salem, Tamil Nadu 636006, India</p>
                                       ...
                                       <p style="font-size: 12px;margin-top: -12px;">meeting Schedule Date : 03 Jan 2025 | 11:38 AM</p>
                                       <span class="badge bg-warning" style="font-size: 12px;">Schedule Pendings</span>
                                     </div> <br>   
                                    </div>

                                    <div class="alert alert-success" role="alert">
                                        <h4 class="alert-heading">Meetings feedbacks!</h4>
...
<script src="{{ asset('/assets/admin/ticket-details.js') }}"></script>
    ...
    <script>
        ...
        var myDropzone = new Dropzone("div#dropzoneDragArea", { 
          paramName: "file",
          url: "{{ url('/storeAdminImage') }}",
		  clickable: ".form-group.dropzone",
...
<script type="text/javascript">
	...
	const myticketfetchUrl = "{{ route('admin.myticketfetch') }}";
    const ticketfetchUrl = "{{ route('admin.ticketfetch') }}";
	const ticketfillter = "{{ route('admin.ticketfillter') }}";
	const myticketfillter = "{{ route('admin.myticketfillter') }}";
    const ticketdatefillter = "{{ route('admin.ticketdatefillter') }}";
	const myticketdatefillter = "{{ route('admin.myticketdatefillter') }}";
    const fetchUrlmorefitter = "{{ route('admin.fetchticketfitter') }}";
    const fetchMymorefitter = "{{ route('admin.fetchmyticketfitter') }}";
    const fetchUrlticketfitterremove = "{{ route('admin.fetchticketfitterremove') }}";
    const fetchMyticketfitterremove = "{{ route('admin.fetchmyticketfitterremove') }}";
