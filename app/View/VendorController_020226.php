...
public function getvendorchart(Request $request)
{
    ...
    $balance = Tblbill::where('vendor_id', $id)->where('delete_status',0)
...
//bill making
    ...
    public function getbill(Request $request)
    {
        ...
        $query = Tblbill::with(['BillLines','Tblvendor','TblBilling','Tblbankdetails','Purchase','Purchase.quotation','billPayments'])->where('delete_status',0)->orderBy('id', 'desc');
 ...
 public function getbillmade(Request $request)
    {
        ...
        $Tblvendor = Tblvendor::orderBy('id', 'asc')->get();
        $Tblaccount = Tblaccount::orderBy('id', 'asc')->get();
        $query = Tblbillpay::with(['BillLines','BillLines.Bill','BillLines.BillLines','BillLines.aleardypay','Tblvendor','TblBilling','Tblbankdetails'])->where('delete_status',0)->orderBy('id', 'desc');
...
public function gettdssummary(Request $request)
    {
        ...
        $billlist = Tblbill::with(['BillLines','Tblvendor','TblBilling','Tblbankdetails','TblTDSsection','TblTDSsection.section'])->orderBy('id', 'desc')->where('tax_amount', '>', 0)->where('delete_status',0)->where('tds_paid_status','Not Paid')->paginate($perPage)->appends(['per_page' => $perPage]);
...
public function gettdsreport(Request $request)
    {
        ...
        $billlist = Tblbill::with(['BillLines','Tblvendor','TblBilling','Tblbankdetails','TblTDSsection','TblTDSsection.section'])->orderBy('id', 'desc')->where('delete_status',0)->where('tds_paid_status','Paid')->where('tax_amount', '>', 0)->paginate($perPage)->appends(['per_page' => $perPage]);
        // dd($billlist);
...
public function getgstsummary(Request $request)
    {
        ...
        $billlist = Tblbill::with(['BillLines','Tblvendor','TblBilling','Tblbankdetails'])->whereHas('BillLines', function ($q) {
                    $q->whereRaw('CAST(gst_amount AS DECIMAL(10,2)) > 0');
                })->where('delete_status',0)->orderBy('id', 'desc')->paginate($perPage)->appends(['per_page' => $perPage]);
