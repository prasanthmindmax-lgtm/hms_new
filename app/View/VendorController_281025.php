...
//bill making
    ...
    public function getbill(Request $request)
    {
        ...
        $query = Tblbill::with(['BillLines','Tblvendor','TblBilling','Tblbankdetails','Purchase','Purchase.quotation'])->orderBy('id', 'desc');
        ...
        return view('vendor.bill_dashboard', ['admin' => $admin,'locations' => $locations,'billlist' => $billlist,'perPage' => $perPage,'TblZonesModel' => $TblZonesModel,'Tblcompany' => $Tblcompany, 'Tblvendor' => $Tblvendor, 'Tblaccount' => $Tblaccount]);
    }
 ...
 public function getbillmade(Request $request)
    {
        ...
        return view('vendor.bill_made_dashboard', ['admin' => $admin,'locations' => $locations,'billpaylist' => $billpaylist,'serial' => $serial,'perPage' => $perPage,'TblZonesModel' => $TblZonesModel, 'Tblvendor' => $Tblvendor,'Tblcompany' => $Tblcompany,'Tblaccount' => $Tblaccount]);
    }
...
public function getpurchaseorder(Request $request)
    {
        ...
        return view('vendor.purchase_bashboard', ['admin' => $admin,'locations' => $locations,'purchaselist' => $purchaselist,'perPage' => $perPage,'TblZonesModel' => $TblZonesModel,'TblPoEmail' => $TblPoEmail,'Tblcompany' => $Tblcompany, 'Tblvendor' => $Tblvendor,'Tblaccount' => $Tblaccount]);
    }
...
public function gettdssummary(Request $request)
    {
        ...
        return view('vendor.tds_summary', ['admin' => $admin,'locations' => $locations,'billlist' => $billlist,'perPage' => $perPage,'TblZonesModel' => $TblZonesModel,'Tbltdssection' => $Tbltdssection,'Tblvendor' => $Tblvendor,'Tblcompany' => $Tblcompany]);
    }
