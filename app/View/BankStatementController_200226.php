...
class BankStatementController extends Controller
{
    ...
    public function matchBill(Request $request)
    {
        ...
        try {
            ...
            if ($existingBillPay) {
                ...
                $billPay = TblBillPay::create($billPayData);
                ...
                DB::table('bill_pay_lines_tbl')->insert($lineData);
     ...
     * Restores bill balance and deletes the bill_pay (bill made) record that was created on match.
     */
    public function unmatch($id)
    {
        ...
        try {
            ...
            if ($match) {
                ...
                // Delete the bill_pay (bill made) record created at match
