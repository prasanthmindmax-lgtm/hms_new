...
class FinancialReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $summary = [
            ...
            'total_deposit'  => $summaryQuery->sum('deposit_amount'), // NEW
            'total_upi'      => $summaryQuery->sum('upi_amount'), // NEW
    ...
    public function getAttachments($id)
    {
        ...
        $attachments = [
            ...
            'deposit' => [
                'label' => 'Deposit Files',
                'files' => $report->deposit_files ?? [],
            ],
            'upi' => [
                'label' => 'UPI Payment Files',
                'files' => $report->upi_files ?? [],
            ],
        ];
